...
namespace CalamityMod.Particles
{
    public class PulseRing : Particle
    {
        ...
        {
            Texture2D tex = ModContent.GetTexture("CalamityMod/Particles/HollowCircleHardEdge"); //GeneralParitcleHandler.GetTexture somehow wont work for set particles and defaults to the first particle it has (blood)
