...
{
    public class DragonFlames : DragonsBreathParticleSets
    {
        public override Color BorderColor => (Main.rand.NextBool() ? Color.OrangeRed : Color.DarkOrange) * 0.8f;
    }
    public class DragonBeam : DragonsBreathParticleSets
    {
        public override Color BorderColor => (Main.rand.NextBool() ? Color.Orange : Color.OrangeRed) * 0.7f;
    }

    public abstract class DragonsBreathParticleSets : BaseFusableParticleSet
    {
        ...
        {
            Texture2D fusableParticleBase = ModContent.Request<Texture2D>("CalamityMod/Particles/Metaballs/FusableParticleMessy").Value;
