...
{
    public class AltLineParticle : Particle
    {
        ...
        public AltLineParticle(Vector2 relativePosition, Vector2 velocity, bool affectedByGravity, int lifetime, float scale, Color color)
        {
