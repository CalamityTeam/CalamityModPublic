...
namespace CalamityMod.Particles
{
    public class SnowflakeSparkle : Particle
    {
        ...
        {
            Texture2D spokesTexture = GeneralParticleHandler.Assets.Request<Texture2D>(Type).Value;
            ...
            for (int i = 0; i < Spokes; i++)
            {
                ...
                spriteBatch.Draw(spokesTexture, Position - Main.screenPosition, null, Color * opacity * 0.5f, Rotation + rotation, spokesTexture.Size() / 2f, Scale, SpriteEffects.None, 0);
            }
        }
    }
}
