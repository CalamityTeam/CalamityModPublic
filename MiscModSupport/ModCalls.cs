...
namespace CalamityMod.MiscModSupport
{
	public class ModCalls
	{
		...
		public static bool GetSetBonus(Player p, string setBonus)
		{
			...
			{
				default: break;
				case "daedalus": return mp.daedalusReflect || mp.daedalusShard || mp.daedalusAbsorb || mp.daedalusCrystal || mp.daedalusSplit;
				case "daedalus_melee":
				case "daedalus melee": return mp.daedalusReflect;
				case "daedalus_ranged":
				case "daedalus ranged": return mp.daedalusShard;
				case "daedalus_magic":
				case "daedalus magic": return mp.daedalusAbsorb;
				case "daedalus_summon":
				case "daedalus summon": return mp.daedalusCrystal;
				case "daedalus_rogue":
				case "daedalus rogue": return mp.daedalusSplit;
			}
			...
			{
				default: break;
				case "reaver": return mp.reaverBlast || mp.reaverDoubleTap || mp.reaverBurst || mp.reaverOrb || mp.reaverSpore;
				case "reaver_melee":
				case "reaver melee": return mp.reaverBlast;
				case "reaver_ranged":
				case "reaver ranged": return mp.reaverDoubleTap;
				case "reaver_magic":
				case "reaver magic": return mp.reaverBurst;
				case "reaver_summon":
				case "reaver summon": return mp.reaverOrb;
				case "reaver_rogue":
				case "reaver rogue": return mp.reaverSpore;
			}
			...
			{
				default: break;
				case "ataxia": return mp.ataxiaBlaze;
				case "ataxia_melee":
				case "ataxia melee": return mp.ataxiaGeyser;
				case "ataxia_ranged":
				case "ataxia ranged": return mp.ataxiaBolt;
				case "ataxia_magic":
				case "ataxia magic": return mp.ataxiaMage;
				case "ataxia_summon":
				case "ataxia summon": return mp.chaosSpirit;
				case "ataxia_rogue":
				case "ataxia rogue": return mp.ataxiaVolley;
			}
			...
			{
				default: break;
				case "tarragon": return mp.tarraSet;
				case "tarragon_melee":
				case "tarragon melee": return mp.tarraMelee;
				case "tarragon_ranged":
				case "tarragon ranged": return mp.tarraRanged;
				case "tarragon_magic":
				case "tarragon magic": return mp.tarraMage;
				case "tarragon_summon":
				case "tarragon summon": return mp.tarraSummon;
				case "tarragon_rogue":
				case "tarragon rogue": return mp.tarraThrowing;
			}
			...
			{
				default: break;
				case "bloodflare": return mp.bloodflareSet;
				case "bloodflare_melee":
				case "bloodflare melee": return mp.bloodflareMelee;
				case "bloodflare_ranged":
				case "bloodflare ranged": return mp.bloodflareRanged;
				case "bloodflare_magic":
				case "bloodflare magic": return mp.bloodflareMage;
				case "bloodflare_summon":
				case "bloodflare summon": return mp.bloodflareSummon;
				case "bloodflare_rogue":
				case "bloodflare rogue": return mp.bloodflareThrowing;
			}
			...
			switch (setBonus)
			{
				default: break;
				case "godslayer":
				case "god slayer": return mp.godSlayer;
				case "godslayer_melee":
				case "godslayer melee":
				case "god slayer melee": return mp.godSlayerDamage; // melee helm's unique damage reducing property
				case "godslayer_ranged":
				case "godslayer ranged":
				case "god slayer ranged": return mp.godSlayerRanged;
				case "godslayer_magic":
				case "godslayer magic":
				case "god slayer magic": return mp.godSlayerMage;
				case "godslayer_summon":
				case "godslayer summon":
				case "god slayer summon": return mp.godSlayerSummon;
				case "godslayer_rogue":
				case "godslayer rogue":
				case "god slayer rogue": return mp.godSlayerThrowing;
			}
			...
			{
				default: break;
				case "silva": return mp.silvaSet;
				case "silva_melee":
				case "silva melee": return mp.silvaMelee;
				case "silva_ranged":
				case "silva ranged": return mp.silvaRanged;
				case "silva_magic":
				case "silva magic": return mp.silvaMage;
				case "silva_summon":
				case "silva summon": return mp.silvaSummon;
				case "silva_rogue":
				case "silva rogue": return mp.silvaThrowing;
			}
        ...
        public static object Call(params object[] args)
		{
			...
			switch (methodName)
			{
				...
				case "BossDowned":
				case "GetBossDowned":
					if (args.Length < 2) return new ArgumentNullException("ERROR: Must specify a boss or event name as a string.");
					if (!(args[1] is string)) return new ArgumentException("ERROR: The argument to \"Downed\" must be a string.");
				...
				case "InZone":
				case "GetInZone":
					if (args.Length < 2) return new ArgumentNullException("ERROR: Must specify both a Player object (or int index of a Player) and a zone name as a string.");
					if (args.Length < 3) return new ArgumentNullException("ERROR: Must specify a zone name as a string.");
					if (!(args[2] is string)) return new ArgumentException("ERROR: The second argument to \"InZone\" must be a string.");
					if (!(args[1] is int) || !(args[1] is Player)) return new ArgumentException("ERROR: The first argument to \"InZone\" must be a Player or an int.");
				...
				case "GetDifficultyActive":
					if (args.Length < 2) return new ArgumentNullException("ERROR: Must specify a difficulty modifier name as a string.");
					if (!(args[1] is string)) return new ArgumentException("ERROR: The argument to \"Difficulty\" must be a string.");
				...
				case "GetSetBonusActive":
					if (args.Length < 2) return new ArgumentNullException("ERROR: Must specify both a Player object (or int index of a Player) and a set bonus name as a string.");
					if (args.Length < 3) return new ArgumentNullException("ERROR: Must specify a set bonus name as a string.");
					if (!(args[2] is string)) return new ArgumentException("ERROR: The second argument to \"SetBonus\" must be a string.");
					if (!(args[1] is int) || !(args[1] is Player)) return new ArgumentException("ERROR: The first argument to \"SetBonus\" must be a Player or an int.");
