...
namespace CalamityMod.NPCs
{
    public class BlindedAngler : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.GetTexture("CalamityMod/NPCs/SunkenSeaNPCs/BlindedAnglerGlow").Width, (float)(ModContent.GetTexture("CalamityMod/NPCs/SunkenSeaNPCs/BlindedAnglerGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture("CalamityMod/NPCs/SunkenSeaNPCs/BlindedAnglerGlow"), vector,
