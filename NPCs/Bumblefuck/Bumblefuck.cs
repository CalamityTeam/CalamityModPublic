		...
		public override void AI()
		{
			...
			if (npc.ai[0] == 0f) 
			{
				...
				if (npc.ai[1] >= 180f && Main.netMode != 1) 
				{
                    ...
                    while (npc.ai[0] == 0f)
                    {
                        int damage = Main.expertMode ? 65 : 80; //260 160
                        int num1307 = Main.rand.Next(6);
                        ...
                        else if (num1307 >= 2 && NPC.CountNPCS(mod.NPCType("Bumblefuck2")) < num1305)
                        {
			...
			else 
			{
				...
				else 
				{
					...
					else 
					{
						if (npc.ai[0] == 3.2f) 
						{
							npc.damage = (int)((double)npc.defDamage * 1.75);
							npc.collideX = false;
							npc.collideY = false;
							npc.noTileCollide = true;
