		...
		public override void AI()
        {
            ...
            else if (npc.ai[0] == 1f)
            {
                ...
                if (npc.velocity.Y == 0f)
                {
                    ...
                    float num1879 = 60f;
                    float num1880 = BossRushEvent.BossRushActive ? 12f : 3f;
					if (revenge)
					{
                ...
                if (npc.ai[2] >= 420f && npc.velocity.Y == 0f && Main.netMode != NetmodeID.MultiplayerClient)
                {
					switch (Main.rand.Next(3))
					{
						...
						case 1:
							...
							npc.velocity.Y = BossRushEvent.BossRushActive ? -12f : -8f;
							break;
						case 2:
							npc.ai[0] = 5f;
							break;
            ...
            else if (npc.ai[0] == 3f)
            {
                ...
                if (npc.ai[2] == 1f)
                {
                    ...
                    vector272.Normalize();
                    vector272 *= BossRushEvent.BossRushActive ? 12f : 8f;
                ...
                else
                {
                    ...
                    vector272.Normalize();
                    vector272 *= BossRushEvent.BossRushActive ? 18f : 12f;
            ...
            else
            {
                if (npc.ai[0] == 4f)
                {
                    ...
                    {
                        value74.Normalize();
                        value74 *= BossRushEvent.BossRushActive ? 22f : 14f;
                    }
                ...
                if (npc.ai[0] == 5f)
                {
                    if (npc.velocity.Y == 0f)
                    {
                        ...
                        if (npc.ai[1] > 5f)
                        {
                            ...
                            npc.velocity.X = (float)((BossRushEvent.BossRushActive ? 22 : 14) * npc.direction);
                            npc.ai[2] += 1f;
                        }
                    }
                    else
