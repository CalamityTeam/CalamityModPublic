...
namespace CalamityMod.NPCs.Perforator
{
    ...
    public class PerforatorHeadSmall : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (!flag2)
            {
                for (int k = num12; k < num13; k++)
                {
                    ...
                    {
                        if (Main.tile[k, l] != null && ((Main.tile[k, l].nactive() && (Main.tileSolid[(int)Main.tile[k, l].TileType] || (Main.tileSolidTop[(int)Main.tile[k, l].TileType] && Main.tile[k, l].TileFrameY == 0))) || Main.tile[k, l].LiquidAmount > 64))
                        {
                            Vector2 vector2;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            texture2D15 = ModContent.Request<Texture2D>("CalamityMod/NPCs/Perforator/PerforatorHeadSmallGlow");
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                Gore.NewGore(NPC.position, NPC.velocity, Mod.GetGoreSlot("Gores/SmallPerf"), NPC.scale);
            }
        }
