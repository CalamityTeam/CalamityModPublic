...
namespace CalamityMod.NPCs.Perforator
{
    public class PerforatorBodySmall : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            texture2D15 = ModContent.Request<Texture2D>("CalamityMod/NPCs/Perforator/PerforatorBodySmallGlow");
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                Gore.NewGore(NPC.position, NPC.velocity, Mod.GetGoreSlot("Gores/SmallPerf2"), NPC.scale);
            }
        }
