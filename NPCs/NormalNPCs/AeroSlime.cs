...
namespace CalamityMod.NPCs
{
    public class AeroSlime : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.AeroSlimeBanner>();
        }
        ...
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<Items.AerialiteOre>(), Main.rand.Next(10, 27));
        }
    }
}
