...
namespace CalamityMod.NPCs
{
    public class StormlionCharger : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.StormlionBanner>();
        }
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<Items.StormlionMandible>());
            }
        }
    }
}
