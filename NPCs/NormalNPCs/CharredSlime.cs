...
namespace CalamityMod.NPCs
{
    public class CharredSlime : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.CharredSlimeBanner>();
        }
        ...
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<Items.CharredOre>(), Main.rand.Next(10, 27));
        }
    }
}
