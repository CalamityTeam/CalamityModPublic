...
namespace CalamityMod.NPCs
{
    public class CrawlerSapphire : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            banner = npc.type;
            bannerItem = ModContent.ItemType<Items.SapphireCrawlerBanner>();
        }
        ...
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.Sapphire, Main.rand.Next(2, 5));
        }
    }
}
