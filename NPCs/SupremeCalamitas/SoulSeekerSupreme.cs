...
namespace CalamityMod.NPCs.SupremeCalamitas
{
    public class SoulSeekerSupreme : ModNPC
    {
        ...
        public override bool PreAI()
        {
            ...
            if (timer > shootRate)
            {
                for (int i = 0; i < Main.maxNPCs; i++)
                {
                    ...
                    {
                        if (seeker == NPC)
                            SoundEngine.PlaySound(Mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Custom/SCalSounds/BrimstoneShoot"), SCal.Center);
                        break;
                    }
                }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            texture2D15 = ModContent.Request<Texture2D>("CalamityMod/NPCs/SupremeCalamitas/SoulSeekerSupremeGlow");
