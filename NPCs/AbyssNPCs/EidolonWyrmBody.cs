...
namespace CalamityMod.NPCs
{
    public class EidolonWyrmBody : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/EidolonWyrmBodyGlow").Width, (float)(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/EidolonWyrmBodyGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/EidolonWyrmBodyGlow"), vector,
