...
namespace CalamityMod.NPCs.AbyssNPCs
{
    public class EidolonWyrmBody : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)mod.GetTexture("NPCs/AbyssNPCs/EidolonWyrmBodyGlow").Width, (float)(mod.GetTexture("NPCs/AbyssNPCs/EidolonWyrmBodyGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(mod.GetTexture("NPCs/AbyssNPCs/EidolonWyrmBodyGlow"), vector,
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (npc.life <= 0)
            {
                ...
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/Wyrm2"), 1f);
            }
        }
