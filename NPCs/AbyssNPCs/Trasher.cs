...
namespace CalamityMod.NPCs.AbyssNPCs
{
    public class Trasher : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			if (spawnInfo.player.GetCalamityPlayer().ZoneSulphur || (spawnInfo.player.GetCalamityPlayer().ZoneSulphur && spawnInfo.water))
			{
				return 0.1f;
			}
			return 0f;
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Trasher"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Trasher2"), 1f);
			}
		}
	}
}
