...
namespace CalamityMod.NPCs
{
    public class GulperEelBody : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/GulperEelBodyGlow").Width, (float)(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/GulperEelBodyGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/GulperEelBodyGlow"), vector,
