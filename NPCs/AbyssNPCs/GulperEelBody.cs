...
namespace CalamityMod.NPCs.AbyssNPCs
{
	public class GulperEelBody : ModNPC
	{
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)mod.GetTexture("NPCs/AbyssNPCs/GulperEelBodyGlow").Width, (float)(mod.GetTexture("NPCs/AbyssNPCs/GulperEelBodyGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(mod.GetTexture("NPCs/AbyssNPCs/GulperEelBodyGlow"), vector,
