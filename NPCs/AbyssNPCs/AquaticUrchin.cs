    ...
    public class AquaticUrchin : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/AquaticUrchin"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/AquaticUrchin2"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/AquaticUrchin3"), 1f);
			}
		}
	}
}
