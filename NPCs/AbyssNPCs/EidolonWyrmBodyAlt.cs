...
namespace CalamityMod.NPCs.AbyssNPCs
{
	public class EidolonWyrmBodyAlt : ModNPC
	{
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)mod.GetTexture("NPCs/AbyssNPCs/EidolonWyrmBodyAltGlow").Width, (float)(mod.GetTexture("NPCs/AbyssNPCs/EidolonWyrmBodyAltGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(mod.GetTexture("NPCs/AbyssNPCs/EidolonWyrmBodyAltGlow"), vector,
		...
		public override void HitEffect(int hitDirection, double damage)
		{
            ...
            if (npc.life <= 0)
            {
                ...
                Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/Wyrm3"), 1f);
            }
        }
