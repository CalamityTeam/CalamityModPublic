    ...
    public class Mauler : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Mauler"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Mauler2"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Mauler3"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Mauler4"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/Mauler5"), 1f);
			}
		}
	}
}
