...
namespace CalamityMod.NPCs
{
    public class GiantSquid : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/GiantSquidGlow").Width, (float)(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/GiantSquidGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/GiantSquidGlow"), vector,
        ...
        public override void NPCLoot()
        {
            ...
            if (NPC.downedPlantBoss || CalamityWorld.downedCalamitas)
            {
                ...
                if (Main.rand.NextBool(2))
                {
                    Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<DepthCells>(), Main.rand.Next(2, 5));
                }
