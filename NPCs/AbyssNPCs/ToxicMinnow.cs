...
namespace CalamityMod.NPCs.AbyssNPCs
{
	public class ToxicMinnow : ModNPC
	{
		...
		public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)mod.GetTexture("NPCs/AbyssNPCs/ToxicMinnowGlow").Width, (float)(mod.GetTexture("NPCs/AbyssNPCs/ToxicMinnowGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(mod.GetTexture("NPCs/AbyssNPCs/ToxicMinnowGlow"), vector,
        ...
        public override void HitEffect(int hitDirection, double damage)
		{
			for (int k = 0; k < 5; k++)
			{
				Dust.NewDust(npc.position, npc.width, npc.height, 40, hitDirection, -1f, 0, default(Color), 1f);
			}
			if (npc.life <= 0)
			{
				for (int k = 0; k < 50; k++)
