...
namespace CalamityMod.NPCs.AbyssNPCs
{
    public class GulperEelBodyAlt : ModNPC
	{
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)mod.GetTexture("NPCs/AbyssNPCs/GulperEelBodyAltGlow").Width, (float)(mod.GetTexture("NPCs/AbyssNPCs/GulperEelBodyAltGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(mod.GetTexture("NPCs/AbyssNPCs/GulperEelBodyAltGlow"), vector,
