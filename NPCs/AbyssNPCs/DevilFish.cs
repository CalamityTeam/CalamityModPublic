...
namespace CalamityMod.NPCs
{
    public class DevilFish : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/DevilFishGlow").Width, (float)(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/DevilFishGlow").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.GetTexture("CalamityMod/NPCs/AbyssNPCs/DevilFishGlow"), vector,
        ...
        public override void NPCLoot()
        {
            ...
            {
                Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<ChaoticOre>(), Main.rand.Next(3, 10));
                if (Main.rand.NextBool(200))
                {
                    Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<Hellborn>());
                }
            }
        }
