    ...
    public class AquaticScourgeTail : ModNPC
	{
        ...
        public override void HitEffect(int hitDirection, double damage)
		{
            ...
            if (npc.life <= 0)
            {
				...
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/ASTail"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/ASTail2"), 1f);
			}
        }
