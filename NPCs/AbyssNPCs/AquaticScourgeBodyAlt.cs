    ...
    public class AquaticScourgeBodyAlt : ModNPC
	{
        ...
        public override void HitEffect(int hitDirection, double damage)
		{
            ...
            if (npc.life <= 0)
            {
				...
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/ASBodyAlt"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/ASBodyAlt2"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/AquaticScourgeGores/ASBodyAlt3"), 1f);
			}
        }
