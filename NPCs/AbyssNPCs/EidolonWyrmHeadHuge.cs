...
namespace CalamityMod.NPCs.AbyssNPCs
{
	public class EidolonWyrmHeadHuge : ModNPC
	{
        ...
        {
            if (spawnInfo.player.GetModPlayer<CalamityPlayer>(mod).ZoneAbyssLayer3 && spawnInfo.water && !NPC.AnyNPCs(mod.NPCType("EidolonWyrmHeadHuge")) &&
        ...
        public override void NPCLoot()
        {
            ...
            if (Main.rand.Next(10) == 0 && CalamityWorld.revenge)
            {
