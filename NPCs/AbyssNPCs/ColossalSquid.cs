    ...
    public class ColossalSquid : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/ColossalSquid"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/ColossalSquid2"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/ColossalSquid3"), 1f);
				Gore.NewGore(npc.Center, npc.velocity, mod.GetGoreSlot("Gores/ColossalSquid4"), 1f);
			}
		}
	}
}
