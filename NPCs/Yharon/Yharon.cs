...
namespace CalamityMod.NPCs.Yharon
{
    ...
    public class Yharon : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] == -1f)
            {
                ...
                if (NPC.ai[2] == fireTornadoPhaseTimer - 30)
                {
                    ...
                    SoundEngine.PlaySound(Mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Custom/YharonRoar"), (int)NPC.position.X, (int)NPC.position.Y);
                }
            ...
            else if (NPC.ai[0] == 3f)
            {
                ...
                if (NPC.ai[2] == fireTornadoPhaseTimer - 30)
                    SoundEngine.PlaySound(Mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Custom/YharonRoarShort"), (int)NPC.position.X, (int)NPC.position.Y);
        ...
        public void Yharon_AI2(bool expertMode, bool revenge, bool death, bool malice, float pie, float lifeRatio, Vector2 vectorCenter, CalamityGlobalNPC calamityGlobalNPC)
        {
            ...
            else if (NPC.ai[0] == 3f)
            {
                ...
                if (NPC.ai[1] == fireballBreathTimer)
                {
                    ...
                    SoundEngine.PlaySound(Mod.GetLegacySoundSlot(SoundType.Custom, "Sounds/Custom/YharonFire"), NPC.Center);
                }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            {
                texture = ModContent.Request<Texture2D>("CalamityMod/NPCs/Yharon/YharonGlowOrange");
                ...
                Texture2D texture2 = ModContent.Request<Texture2D>("CalamityMod/NPCs/Yharon/YharonGlowGreen");
                ...
                Texture2D texture3 = ModContent.Request<Texture2D>("CalamityMod/NPCs/Yharon/YharonGlowPurple");
