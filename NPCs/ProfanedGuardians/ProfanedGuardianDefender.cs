        ...
        public override void AI()
        {
            ...
            else if (NPC.ai[0] == 2f)
            {
                ...
                if (Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    if (NPC.localAI[1] >= projectileGateValue && Vector2.Distance(NPC.Center, player.Center) > 160f)
                    {
                        NPC.localAI[1] = 0f;
