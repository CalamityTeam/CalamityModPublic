	...
	public class CalamityGlobalTownNPC
	{
		...
		public static void ShopSetup(int type, Mod mod, ref Chest shop, ref int nextSlot)
		{
			...
			if (type == NPCID.Wizard)
			{
                ...
                SetShopItem(ref shop, ref nextSlot, ItemID.RodofDiscord, Main.hardMode && Main.LocalPlayer.ZoneHoly, price: Item.buyPrice(8), true); // Might need to be more expensive - Merkalto
