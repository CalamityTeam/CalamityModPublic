    ...
    public class SoulSlurper : ModNPC
    {
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			for (int num163 = 1; num163 < num153; num163++)
			{
				...
				spriteBatch.Draw(texture2D15, vector44, new Rectangle?(npc.frame), color41, npc.rotation, vector11, npc.scale, npc.spriteDirection == 1 ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 0f);
			}

			spriteBatch.Draw(texture2D15, vector43, new Rectangle?(npc.frame), color37, npc.rotation, vector11, npc.scale, npc.spriteDirection == 1 ? SpriteEffects.None : SpriteEffects.FlipHorizontally, 0f);
