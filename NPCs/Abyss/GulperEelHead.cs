...
namespace CalamityMod.NPCs.Abyss
{
    public class GulperEelHead : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.Request<Texture2D>("CalamityMod/NPCs/Abyss/GulperEelHeadGlow").Width, (float)(ModContent.Request<Texture2D>("CalamityMod/NPCs/Abyss/GulperEelHeadGlow").Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityMod/NPCs/Abyss/GulperEelHeadGlow"), vector,
