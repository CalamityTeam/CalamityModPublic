...
namespace CalamityMod.NPCs.Abyss
{
    public class DevilFish : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.Request<Texture2D>("CalamityMod/NPCs/Abyss/DevilFishGlow").Width, (float)(ModContent.Request<Texture2D>("CalamityMod/NPCs/Abyss/DevilFishGlow").Height / Main.npcFrameCount[NPC.type])) * 1f / 2f;
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("CalamityMod/NPCs/Abyss/DevilFishGlow"), vector,
