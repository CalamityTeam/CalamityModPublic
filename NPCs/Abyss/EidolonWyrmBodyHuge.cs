...
namespace CalamityMod.NPCs.Abyss
{
    public class EidolonWyrmBodyHuge : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            vector -= new Vector2((float)ModContent.GetTexture("CalamityMod/NPCs/Abyss/EidolonWyrmBodyGlowHuge").Width, (float)(ModContent.GetTexture("CalamityMod/NPCs/Abyss/EidolonWyrmBodyGlowHuge").Height / Main.npcFrameCount[npc.type])) * 1f / 2f;
