    ...
    public class ColossalSquid : ModNPC
    {
            ...
            else
            {
                ...
                if (hasBeenHit)
                {
                    ...
                    if (Main.netMode != NetmodeID.MultiplayerClient && NPC.localAI[0] >= 150f)
                    {
                        ...
                        SoundEngine.PlaySound(SoundID.Item, (int)NPC.position.X, (int)NPC.position.Y, 111);
                        Projectile.NewProjectile(NPC.GetSpawnSource_ForProjectile(), NPC.Center.X, NPC.Center.Y + 60, 0f, 2f, ModContent.ProjectileType<InkBombHostile>(), damage, 0f, Main.myPlayer, 0f, 0f);
                    }
                    NPC.rotation = NPC.velocity.X * 0.05f;
                    NPC.velocity *= 0.975f;
                    float num263 = 2.5f;
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                {
                    Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/ColossalSquid").Type, 1f);
                    Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/ColossalSquid2").Type, 1f);
                    Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/ColossalSquid3").Type, 1f);
                    Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/ColossalSquid4").Type, 1f);
                }
            }
        }
    }
