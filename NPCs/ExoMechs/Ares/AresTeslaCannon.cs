...
namespace CalamityMod.NPCs.ExoMechs.Ares
{
    public class AresTeslaCannon : ModNPC
    {
        ...
        private const float teslaOrbTelegraphDuration = 144f;
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                {
                    Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Ares/AresTeslaCannon1").Type, 1f);
                    Gore.NewGore(NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Ares/AresTeslaCannon2").Type, 1f);
