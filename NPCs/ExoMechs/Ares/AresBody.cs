	...
	public class AresBody : ModNPC
	{
			...
			switch ((int)AIState)
			{
				...
				case (int)Phase.Deathrays:
					...
					else
					{
						...
						if (distanceFromTarget > 2400f && EnragedState == (float)Enraged.No)
						{
							// Play enrage sound
		...
		public void DrawArm(SpriteBatch spriteBatch, Vector2 handPosition, Color glowmaskColor, int direction, bool backArm)
		{
			...
			else
			{
				...
				Texture2D connectorTexture = ModContent.GetTexture("CalamityMod/ExtraTextures/AresBottomArmConnector");
