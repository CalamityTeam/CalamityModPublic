...
{
    public class AcidRainT3Biome : ModBiome
    {
        ...
        {
            DisplayName.SetDefault("Acid Rain Tier 3");
        }
        ...
        {
            return AcidRainEvent.AcidRainEventIsOngoing && DownedBossSystem.downedPolterghast;
        }*/
    }
}
