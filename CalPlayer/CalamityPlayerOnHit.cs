    ...
    public partial class CalamityPlayer : ModPlayer
    {
            ...
            if (item.CountsAsClass<MeleeDamageClass>())
            {
                if (npcCheck)
                {
                    if (ataxiaGeyser && Player.ownedProjectileCounts[ProjectileType<ChaoticGeyser>()] < 3)
                    {
                        ...
                        if (oldFashioned)
                            geyserDamage = CalamityUtils.CalcOldFashionedDamage(geyserDamage);
        ...
        public void ProjOnHit(Projectile proj, Vector2 position, bool crit, bool npcCheck)
        {
            ...
            if (alchFlask && Player.ownedProjectileCounts[ProjectileType<PlagueSeeker>()] < 3 && hasClass)
            {
                ...
                if (oldFashioned)
                    seekerDamage = CalamityUtils.CalcOldFashionedDamage(seekerDamage);
                ...
                if (tarraRanged && proj.CountsAsClass<RangedDamageClass>() && tarraRangedCooldown <= 0)
                {
                    ...
                    if (Player.ownedProjectileCounts[ProjectileType<TarraEnergy>()] < 2)
                    {
                        for (int projCount = 0; projCount < 2; projCount++)
                        {
                            ...
                            if (oldFashioned)
                                energyDamage = CalamityUtils.CalcOldFashionedDamage(energyDamage);
        ...
        private void MagicOnHit(Projectile proj, CalamityGlobalProjectile modProj, Vector2 position, bool crit, bool npcCheck)
        {
            ...
            if (ataxiaMage && ataxiaDmg <= 0)
            {
                ...
                if (oldFashioned)
                    orbDamage = CalamityUtils.CalcOldFashionedDamage(orbDamage);
            ...
            if (npcCheck)
            {
                if (bloodflareMage && bloodflareMageCooldown <= 0 && crit)
                {
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        if (oldFashioned)
                            bloodflareFireballDamage = CalamityUtils.CalcOldFashionedDamage(bloodflareFireballDamage);
            ...
            if (silvaMage && silvaMageCooldown <= 0 && (proj.penetrate == 1 || proj.timeLeft <= 5))
            {
                ...
                if (oldFashioned)
                    silvaBurstDamage = CalamityUtils.CalcOldFashionedDamage(silvaBurstDamage);
            ...
            if (summonExceptionList.TrueForAll(x => proj.type != x))
            {
                if (summonProjCooldown <= 0)
                {
                    if (nucleogenesis)
                    {
                        ...
                        if (oldFashioned)
                            apparatusDamage = CalamityUtils.CalcOldFashionedDamage(apparatusDamage);
                    ...
                    else if (starbusterCore)
                    {
                        ...
                        if (oldFashioned)
                            starburstDamage = CalamityUtils.CalcOldFashionedDamage(starburstDamage);
                    ...
                    else if (nuclearFuelRod)
                    {
                        ...
                        if (oldFashioned)
                            nuclearDamage = CalamityUtils.CalcOldFashionedDamage(nuclearDamage);
                    ...
                    else if (jellyChargedBattery)
                    {
                        ...
                        if (oldFashioned)
                            batteryDamage = CalamityUtils.CalcOldFashionedDamage(batteryDamage);
                ...
                if (hallowedPower)
                {
                    if (hallowedRuneCooldown <= 0)
                    {
                        ...
                        if (oldFashioned)
                            hallowedDamage = CalamityUtils.CalcOldFashionedDamage(hallowedDamage);
        ...
        private void RogueOnHit(Projectile proj, CalamityGlobalProjectile modProj, Vector2 position, bool crit, bool npcCheck)
        {
            ...
            if (xerocSet && xerocDmg <= 0 && Player.ownedProjectileCounts[ProjectileType<EmpyreanEmber>()] < 3 && Player.ownedProjectileCounts[ProjectileType<EmpyreanBlast>()] < 3)
            {
                switch (Main.rand.Next(5))
                {
                    case 0:
                        ...
                        if (oldFashioned)
                            starDamage = CalamityUtils.CalcOldFashionedDamage(starDamage);
                    ...
                    case 2:
                        ...
                        if (oldFashioned)
                            fireDamage = CalamityUtils.CalcOldFashionedDamage(fireDamage);
                    ...
                    case 3:
                        ...
                        if (oldFashioned)
                            blastDamage = CalamityUtils.CalcOldFashionedDamage(blastDamage);
                    ...
                    case 4:
                        ...
                        if (oldFashioned)
                            bubbleDamage = CalamityUtils.CalcOldFashionedDamage(bubbleDamage);
            ...
            if (modProj.stealthStrike && rogueCrownCooldown <= 0 && modProj.stealthStrikeHitCount < 3)
            {
                ...
                else if (moonCrown)
                {
                    ...
                    if (oldFashioned)
                        lunarFlareDamage = CalamityUtils.CalcOldFashionedDamage(lunarFlareDamage);
            ...
            if (npcCheck)
            {
                ...
                if (umbraphileSet && ((modProj.stealthStrike && modProj.stealthStrikeHitCount < 3) || Main.rand.NextBool(5)))
                {
                    ...
                    if (oldFashioned)
                        umbraBlastDamage = CalamityUtils.CalcOldFashionedDamage(umbraBlastDamage);
