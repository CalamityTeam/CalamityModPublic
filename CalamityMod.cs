...
namespace CalamityMod
{
    public class CalamityMod : Mod
    {
        ...
        private void LoadClient()
        {
            ...
            Filters.Scene["CalamityMod:BrimstoneCrag"] = new Filter(new MonolithScreenShaderData("FilterMiniTower").UseColor(1.1f, 0.3f, 0.3f).UseOpacity(0.65f), EffectPriority.VeryHigh);
