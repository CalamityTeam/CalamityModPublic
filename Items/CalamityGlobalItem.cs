...
namespace CalamityMod.Items
{
    public partial class CalamityGlobalItem : GlobalItem
    {
        ...
        {
            tag["rogue"] = rogue;
            tag["timesUsed"] = timesUsed;
            tag["rarity"] = (int)customRarity;
            tag["charge"] = Charge;
            tag["reforgeTier"] = reforgeTier;
            tag["enchantmentID"] = AppliedEnchantment.HasValue ? AppliedEnchantment.Value.ID : 0;
            tag["DischargeEnchantExhaustion"] = DischargeEnchantExhaustion;
            tag["canFirePointBlankShots"] = canFirePointBlankShots;
            tag["trueMelee"] = trueMelee;
        }
            ...
            if (item.accessory)
            {
                ...
                switch (prefix)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        prefix = Mod.Find<ModPrefix>("Quiet").Type;
                        break;
                    case 6:
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        prefix = Mod.Find<ModPrefix>("Cloaked").Type;
                        break;
                    case 11:
                    ...
                    case 16:
                        ...
                        break;
                    case 17:
                        prefix = Mod.Find<ModPrefix>("Camouflaged").Type;
                        break;
                    case 18:
                    ...
                    case 22:
                        ...
                        break;
                    case 23:
                        prefix = Mod.Find<ModPrefix>("Silent").Type;
                        break;
                }
            }
            ...
            else if (item.Calamity().rogue)
            {
                ...
                switch (prefix)
                {
                    case -2:
                        break;
                    case 1:
                        prefix = Mod.Find<ModPrefix>("Radical").Type;
                        break;
                    case 2:
                        prefix = Mod.Find<ModPrefix>("Pointy").Type;
                        break;
                    case 3:
                        prefix = Mod.Find<ModPrefix>("Sharp").Type;
                        break;
                    case 4:
                        prefix = Mod.Find<ModPrefix>("Glorious").Type;
                        break;
                    case 5:
                        prefix = Mod.Find<ModPrefix>("Feathered").Type;
                        break;
                    case 6:
                        prefix = Mod.Find<ModPrefix>("Sleek").Type;
                        break;
                    case 7:
                        prefix = Mod.Find<ModPrefix>("Hefty").Type;
                        break;
                    case 8:
                        prefix = Mod.Find<ModPrefix>("Mighty").Type;
                        break;
                    case 9:
                        prefix = Mod.Find<ModPrefix>("Serrated").Type;
                        break;
                    case 10:
                        prefix = Mod.Find<ModPrefix>("Vicious").Type;
                        break;
                    case 11:
                        prefix = Mod.Find<ModPrefix>("Lethal").Type;
                        break;
                    case 12:
                        prefix = Mod.Find<ModPrefix>("Flawless").Type;
                        break;
                }
            }
            return prefix;
