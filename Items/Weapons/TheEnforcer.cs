...
namespace CalamityMod.Items
{
    public class TheEnforcer : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.rare = 10;
            item.shoot = ModContent.ProjectileType<Projectiles.EssenceFireball>();
            item.shootSpeed = 24f;
        ...
        public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                num80 = num72 / num80;
                Projectile.NewProjectile(vector2.X, vector2.Y, 0f, 0f, ModContent.ProjectileType<Projectiles.EssenceFlame2>(), (int)((float)item.damage * player.meleeDamage * 0.25f), num74, i, 0f, (float)Main.rand.Next(3));
            }
        }
