    ...
    public class TrueConferenceCall : ModItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num108 = 0; num108 < bulletAmt; num108++)
            {
                ...
                num78 *= num80;
                num79 *= num80;
                float speedX4 = num78 + Main.rand.Next(-15, 16) * 0.01f;
                float speedY5 = num79 + Main.rand.Next(-15, 16) * 0.01f;
                int proj = Projectile.NewProjectile(vector2.X, vector2.Y, speedX4, speedY5, type, damage, knockBack, player.whoAmI);
                Main.projectile[proj].extraUpdates += 1;
            }
            return false;
        }
