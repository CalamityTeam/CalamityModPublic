	...
	public class Galeforce : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int i = 0; i < numProj + 1; i++)
			{
				...
				Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X * 0.75f, perturbedSpeed.Y * 0.75f, mod.ProjectileType("FeatherLarge"), (int)((double)damage * 0.25), 0f, player.whoAmI, 0f, 0f);
			}
			return true;
		}
