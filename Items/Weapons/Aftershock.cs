...
namespace CalamityMod.Items.Weapons
{
    public class Aftershock : ModItem
    {
        ...
        public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
        {
			...
			int boulder = Projectile.NewProjectile(vector2.X, vector2.Y, speedX4, speedY5, ProjectileID.BoulderStaffOfEarth, 50, knockback, player.whoAmI, 0f, (float)Main.rand.Next(10));
