	...
	public class CometQuasher : ModItem
	{
		...
		public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
	    {
			...
			for (int num113 = 0; num113 < num112; num113++) 
			{
				...
				int meteor = Projectile.NewProjectile(vector2.X, vector2.Y, num114 * 0.75f, num115 * 0.75f, 424 + Main.rand.Next(3), (int)((double)damage * 0.5f), knockback, player.whoAmI, 0f, 0.5f + (float)Main.rand.NextDouble() * 0.3f);
