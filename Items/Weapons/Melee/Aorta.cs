...
namespace CalamityMod.Items.Weapons.Melee
{
    public class Aorta : ModItem
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<BloodSample>(), 6).AddIngredient(ItemID.Vertebrae, 3).AddIngredient(ItemID.CrimtaneBar, 3).AddTile(TileID.DemonAltar).Register();
        }
    }
}
