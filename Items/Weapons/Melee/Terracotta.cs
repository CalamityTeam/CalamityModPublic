...
namespace CalamityMod.Items.Weapons.Melee
{
    public class Terracotta : ModItem
    {
        ...
        public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(source, target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<TerracottaExplosion>(), (int)(Item.damage * (player.allDamage + player.GetDamage(DamageClass.Melee) - 1f)), knockback, player.whoAmI);
        }
        ...
        public override void OnHitPvp(Player player, Player target, int damage, bool crit)
        {
            ...
            Projectile.NewProjectile(source, target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<TerracottaExplosion>(), (int)(Item.damage * (player.allDamage + player.GetDamage(DamageClass.Melee) - 1f)), Item.knockBack, player.whoAmI);
        }
