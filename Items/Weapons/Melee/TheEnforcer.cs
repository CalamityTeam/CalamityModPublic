    ...
    public class TheEnforcer : ModItem
    {
        ...
        public override void OnHitNPC(Player player, NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                num80 = num72 / num80;
                Projectile.NewProjectile(source, vector2, Vector2.Zero, ModContent.ProjectileType<EssenceFlame2>(), (int)(Item.damage * (player.GetDamage<GenericDamageClass>().Base + player.GetDamage(DamageClass.Melee).Base - 1f) * 0.25f), 0f, i, 0f, Main.rand.Next(3));
            }
        }
