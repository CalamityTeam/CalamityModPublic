...
namespace CalamityMod.Items.Weapons.Melee
{
    public class AegisBlade : ModItem
    {
        ...
        {
            Projectile.NewProjectile(target.Center, Vector2.Zero, ModContent.ProjectileType<AegisBlast>(), (int)(item.damage * player.MeleeDamage()), knockback, Main.myPlayer);
        }

        public override void OnHitPvp(Player player, Player target, int damage, bool crit)
        {
            Projectile.NewProjectile(target.Center, Vector2.Zero, ModContent.ProjectileType<AegisBlast>(), (int)(item.damage * player.MeleeDamage()), item.knockBack, Main.myPlayer);
        }
    }
}
