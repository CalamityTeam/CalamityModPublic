    ...
    public class StaffoftheMechworm : ModItem
	{
        ...
        public override bool Shoot(Player player, ref Microsoft.Xna.Framework.Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			if (head == -1 && tail == -1)
			{
				...
				int curr = Projectile.NewProjectile(vector2.X, vector2.Y, velX, velY, mod.ProjectileType("MechwormHead"), damage, knockBack, owner);

				int prev = curr;
				curr = Projectile.NewProjectile(vector2.X, vector2.Y, velX, velY, mod.ProjectileType("MechwormBody"), damage, knockBack, owner, (float)prev);

				prev = curr;
				curr = Projectile.NewProjectile(vector2.X, vector2.Y, velX, velY, mod.ProjectileType("MechwormBody2"), damage, knockBack, owner, (float)prev);
			...
			else if (head != -1 && tail != -1)
			{
				...
				int back = Projectile.NewProjectile(vector2.X, vector2.Y, velX, velY, mod.ProjectileType("MechwormBody2"), damage, knockBack, owner, (float)body);
