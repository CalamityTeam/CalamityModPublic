...
{
    //TODO -- Add a proper tooltip and balance the weapon, set Stealth Strike to true and what not 
    //(aka add a shoot method cuz it doesnt have it [holy shit this is so bad and outdated])
