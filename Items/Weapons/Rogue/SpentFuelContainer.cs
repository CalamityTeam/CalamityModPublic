...
namespace CalamityMod.Items.Weapons.Rogue
{
    public class SpentFuelContainer : RogueWeapon
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Throws a Throws a fuel container with trace amounts of plutonium that explodes into a nuclear explosion\n" +
                               "The explosion does not occur if there's no tiles below it\n" +
                               "Stealth strikes leave a lingering irradiated zone after the explosion dissipates\n" +
                               "'War Never Changes'"); //Fallout reference breh, pls don't fall out with me :cri:
        }
