...
namespace CalamityMod.Items
{
    public class AnarchyBlade : ModItem
    {
        ...
        {
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, ModContent.ProjectileType<Projectiles.BrimstoneBoom>(), (int)((float)item.damage * player.meleeDamage), knockback, Main.myPlayer);
