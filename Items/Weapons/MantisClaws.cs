...
namespace CalamityMod.Items.Weapons
{
    public class MantisClaws : ModItem
	{
        ...
        {
            Projectile.NewProjectile(target.Center.X, target.Center.Y, 0f, 0f, mod.ProjectileType("FuckYou"), 0, knockback, player.whoAmI, 0f, 0.85f + Main.rand.NextFloat() * 1.15f);
        }
    }
}
