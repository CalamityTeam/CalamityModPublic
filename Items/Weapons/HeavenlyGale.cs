	    ...
	    public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int num119 = 0; num119 < num118; num119++)
			{
				...
				switch (Main.rand.Next(10))
				{
		    		...
		    		case 1:
                    case 2:
                    case 3: type = mod.ProjectileType("TealExoArrow"); break;
                    case 4:
                    case 5:
                    case 6: type = mod.ProjectileType("OrangeExoArrow"); break;
                    case 7:
                    case 8: type = mod.ProjectileType("BlueExoArrow"); break;
                    case 9: type = mod.ProjectileType("GreenExoArrow"); break;
				}
