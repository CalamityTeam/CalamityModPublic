    ...
    public class ArkoftheElements : ModItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num108 = 0; num108 < num107; num108++)
            {
                ...
                Projectile.NewProjectile(vector2.X, vector2.Y, speedX4, speedY5, ModContent.ProjectileType<Projectiles.ElementBall>(), damage, knockBack, player.whoAmI, 0f, (float)Main.rand.Next(3));
            }
            return false;
        }
