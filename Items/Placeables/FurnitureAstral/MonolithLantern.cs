...
namespace CalamityMod.Items.Placeables.FurnitureAstral
{
    public class MonolithLantern : ModItem
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<AstralMonolith>(), 18).AddIngredient(ModContent.ItemType<Stardust>(), 1).AddTile(ModContent.TileType<MonolithCrafting>()).Register();
        }
    }
}
