...
namespace CalamityMod.Items.Placeables.FurniturePlaguedPlate
{
    public class PlaguedPlateBasin : ModItem
    {
        ...
        {
            CreateRecipe(1).AddIngredient(ModContent.ItemType<PlaguedPlate>(), 10).AddIngredient(ModContent.ItemType<PlagueCellCluster>(), 2).AddIngredient(ItemID.Wire, 5).AddTile(ModContent.TileType<PlagueInfuser>()).Register();
        }
    }
}
