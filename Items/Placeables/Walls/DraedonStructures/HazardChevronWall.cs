...
{
    public class HazardChevronWall : ModItem, ILocalizedModType
    {
        ...
        {
            CreateRecipe(4).AddIngredient<TileItems.HazardChevronPanels>().AddTile(TileID.WorkBenches).Register();
        }
    }
}
