...
namespace CalamityMod.Items.Placeables.Furniture
{
    public class TranquilityCandle : ModItem, ILocalizedModType
    {
        ...
        {
            CreateRecipe().AddIngredient(ItemID.PeaceCandle, 3).AddIngredient(ItemID.SoulofLight, 3).AddIngredient(ModContent.ItemType<CoreofEleum>(), 2).AddIngredient(ModContent.ItemType<ZenPotion>()).AddTile(TileID.WorkBenches).Register();
        }
    }
}
