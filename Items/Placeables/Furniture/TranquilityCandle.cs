...
namespace CalamityMod.Items.Placeables.Furniture
{
    public class TranquilityCandle : ModItem, ILocalizedModType
    {
        ...
        {
            CreateRecipe().AddIngredient(ItemID.PeaceCandle, 3).AddIngredient(ItemID.SoulofLight, 3).AddIngredient<CoreofEleum>(2).AddIngredient<ZenPotion>().AddTile(TileID.WorkBenches).Register();
        }
    }
}
