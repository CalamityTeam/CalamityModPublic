...
namespace CalamityMod.Items.Accessories
{
	public class LureofEnthrallment : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Summons a water spirit to fight for you\n" +
                "The spirit stays above you, shooting water spears, ice mist, and treble clefs at nearby enemies");
        }
