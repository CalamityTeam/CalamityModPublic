...
namespace CalamityMod.Items.Materials
{
    public class AuricBar : ModItem
    {
		...
		public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frameI, Color drawColor, Color itemColor, Vector2 origin, float scale)
		{
			...
			spriteBatch.Draw(texture, position, item.GetCurrentFrame(ref frame, ref frameCounter, 6, 15), Color.White, 0f, origin, scale, SpriteEffects.None, 0);
			return false;
		}
		...
		{
			Texture2D texture = ModContent.GetTexture("CalamityMod/Items/Materials/AuricBar_Animated");
			spriteBatch.Draw(texture, item.position - Main.screenPosition, item.GetCurrentFrame(ref frame, ref frameCounter, 6, 15), lightColor, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
			return false;
		}
		...
		public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
		{
			...
			spriteBatch.Draw(texture, item.position - Main.screenPosition, item.GetCurrentFrame(ref frame, ref frameCounter, 6, 15, false), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
		}
