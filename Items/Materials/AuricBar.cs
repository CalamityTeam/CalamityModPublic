...
namespace CalamityMod.Items.Materials
{
    public class AuricBar : ModItem
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalamityMod/Items/Materials/AuricBar_Animated");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalamityMod/Items/Materials/AuricBarGlow");
