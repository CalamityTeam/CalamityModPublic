...
{
    [LegacyName("Malice")]
    public class MaliceModeItem : ModItem
    {
        ...
        {
            SacrificeTotal = 1;
            DisplayName.SetDefault("Tormented Mind of Malice");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalamityMod/Items/DifficultyItems/MaliceModeItem_Animated").Value;
