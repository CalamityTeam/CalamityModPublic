	...
	public partial class CalamityGlobalItem : GlobalItem
	{
		...
		internal static void LoadBalance()
		{
			...
			balance = new SortedDictionary<int, IBalanceRule[]>
			{
				...
				{ ItemID.AmberStaff, Do(DamageRatio(1.33f)) },
				...
				{ ItemID.BeeKeeper, Do(UseTurn, ScaleRatio(1.5f), DamageRatio(2f)) },
				...
				{ ItemID.BookofSkulls, Do(ManaExact(12)) },
				...
				{ ItemID.DemonScythe, Do(DamageRatio(0.75f)) },
				{ ItemID.Drax, Do(TrueMelee, PickPower(200), UseTimeExact(4), TileBoostExact(+1)) },
				...
				{ ItemID.LunarHamaxeNebula, Do(HammerPower(100), AxePower(150), UseTimeExact(5), TileBoostExact(+4)) },
				{ ItemID.LunarHamaxeSolar, Do(HammerPower(100), AxePower(150), UseTimeExact(5), TileBoostExact(+4)) },
				{ ItemID.LunarHamaxeStardust, Do(HammerPower(100), AxePower(150), UseTimeExact(5), TileBoostExact(+4)) },
				{ ItemID.LunarHamaxeVortex, Do(HammerPower(100), AxePower(150), UseTimeExact(5), TileBoostExact(+4)) },
				...
				{ ItemID.MoltenHamaxe, Do(HammerPower(75), AxePower(130), UseTimeExact(14), TileBoostExact(+0)) },
				...
				{ ItemID.ShroomiteDiggingClaw, Do(PickPower(200), UseTimeExact(4), TileBoostExact(-1)) },
				...
				{ ItemID.SpectreHamaxe, Do(HammerPower(90), AxePower(150), UseTimeExact(8), TileBoostExact(+4)) },
				...
				{ ItemID.WandofSparking, Do(DamageRatio(1.33f)) },
