	...
	public partial class CalamityGlobalItem : GlobalItem
	{
		...
		internal static void LoadTweaks()
		{
			...
			currentTweaks = new SortedDictionary<int, IItemTweak[]>
			{
				...
				{ ItemID.CobaltHelmet, Do(DefenseDelta(+5)) },
				{ ItemID.CobaltLeggings, Do(DefenseDelta(+3)) },
				...
				{ ItemID.FrostStaff, Do(ManaExact(9), DamageExact(215), UseTimeExact(50), ShootSpeedExact(40f)) },
