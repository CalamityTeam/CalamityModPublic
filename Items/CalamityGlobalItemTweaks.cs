    ...
    public partial class CalamityGlobalItem : GlobalItem
    {
        ...
        internal static void LoadTweaks()
        {
            ...
            currentTweaks = new SortedDictionary<int, IItemTweak[]>
            {
                ...
                { ItemID.BladeofGrass, Do(AutoReuse, UseTurn, ScaleRatio(1.8f), DamageExact(30), UseExact(38)) },
                ...
                { ItemID.PhoenixBlaster, Do(AutoReuse, PointBlank, DamageExact(13), UseExact(14)) }, // Phoenix Blaster is nerfed to compensate for autofire
                ...
                { ItemID.TheUndertaker, Do(AutoReuse, UseExact(19)) },
