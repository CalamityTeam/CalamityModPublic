    ...
    public partial class CalamityGlobalItem : GlobalItem
    {
        ...
        internal static void LoadTweaks()
        {
            ...
            currentTweaks = new SortedDictionary<int, IItemTweak[]>
            {
                ...
                { ItemID.AdamantiteRepeater, Do(PointBlank, UseTimeExact(18), UseAnimationExact(18), DamageExact(61)) },
                ...
                { ItemID.AntlionClaw, Do(ScaleRatio(1.5f), DamageRatio(1.5f), UseTimeExact(14), UseAnimationExact(14)) },
                ...
                { ItemID.BeesKnees, Do(PointBlank, DamageExact(18), UseTimeExact(38), UseAnimationExact(38)) },
                { ItemID.BladedGlove, Do(DamageExact(15), UseExact(7)) },
                { ItemID.BladeofGrass, Do(AutoReuse, UseTurn, ScaleRatio(1.8f), DamageExact(30), UseTimeExact(38), UseAnimationExact(38)) },
                ...
                { ItemID.Blowpipe, Do(PointBlank, DamageExact(16), UseTimeExact(35), UseAnimationExact(35)) },
                ...
                { ItemID.ChlorophyteShotbow, Do(PointBlank, DamageExact(80), UseTimeExact(50), UseAnimationExact(50)) },
                { ItemID.ChlorophyteWarhammer, Do(HammerPower(90), UseTimeExact(8), TileBoostExact(+2)) },
                { ItemID.ChristmasTreeSword, Do(AutoReuse, UseTurn, DamageExact(114)) },
                ...
                { ItemID.CobaltRepeater, Do(PointBlank, DamageExact(50), UseTimeExact(20), UseAnimationExact(20)) },
                ...
                { ItemID.EnchantedBoomerang, Do(DamageRatio(2f), UseTimeExact(28), UseAnimationExact(28)) },
                ...
                { ItemID.Gatligator, Do(PointBlank, UseTimeExact(6), UseAnimationExact(6)) },
                ...
                { ItemID.HallowedRepeater, Do(PointBlank, UseTimeExact(14), UseAnimationExact(14), DamageExact(57)) },
                { ItemID.HallowJoustingLance, trueMelee },
                { ItemID.Hammush, Do(HammerPower(85), UseTimeExact(10), TileBoostExact(+1)) },
                { ItemID.Handgun, Do(PointBlank, UseTimeExact(15), DamageExact(12), UseAnimationExact(15)) },
                ...
                { ItemID.IceBoomerang, Do(DamageExact(28), UseTimeExact(25), ShootSpeedExact(10), UseAnimationExact(25)) },
                ...
                { ItemID.MedusaHead, Do(ManaExact(6), DamageExact(147)) },
                ...
                { ItemID.Muramasa, Do(ScaleRatio(1.5f), DamageRatio(1.5f), UseTimeExact(14), CritExact(30), UseAnimationExact(14)) },
                ...
                { ItemID.PhoenixBlaster, Do(AutoReuse, PointBlank, DamageExact(13), UseTimeExact(14), UseAnimationExact(14)) }, // Phoenix Blaster is nerfed to compensate for autofire
                ...
                { ItemID.Revolver, Do(PointBlank, AutoReuse, DamageExact(18)) },
                ...
                { ItemID.TheUndertaker, Do(AutoReuse, UseTimeExact(19), UseAnimationExact(19)) },
