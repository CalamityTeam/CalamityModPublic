...
namespace CalamityMod.Items.PermanentBoosters
{
    public class RedLightningContainer : ModItem
    {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalamityMod/Items/PermanentBoosters/RedLightningContainer_Animated");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("CalamityMod/Items/PermanentBoosters/RedLightningContainerGlow");
