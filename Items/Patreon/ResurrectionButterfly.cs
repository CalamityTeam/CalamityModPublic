...
namespace CalamityMod.Items.Patreon
{
    public class ResurrectionButterfly : ModItem
    {
        ...
        public override bool Shoot(Player player, ref Microsoft.Xna.Framework.Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            Projectile.NewProjectile(vector2.X + spinningpoint.X, vector2.Y + spinningpoint.Y, spinningpoint.X, spinningpoint.Y, mod.ProjectileType("PinkButterfly"), damage, num74, i, 0f, 0f);
            spinningpoint = spinningpoint.RotatedBy(-3.1415927410125732, default);
            Projectile.NewProjectile(vector2.X + spinningpoint.X, vector2.Y + spinningpoint.Y, spinningpoint.X, spinningpoint.Y, mod.ProjectileType("PurpleButterfly"), damage, num74, i, 0f, 0f);
            return false;
        }
