    ...
    public class SpearofDestiny : CalamityDamageItem
    {
        ...
        public override bool Shoot(Player player, ref Microsoft.Xna.Framework.Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < numProj + 1; i++)
            {
                ...
                Projectile.NewProjectile(position.X, position.Y, perturbedSpeed.X, perturbedSpeed.Y, i == 1 ? type : ModContent.ProjectileType<IchorSpear2>(), damage, knockBack, player.whoAmI, 0f, 0f);
            }
            return false;
        }
    }
