...
namespace CalamityMod.Items.Armor.GemTech
{
    ...
    public class GemTechHeadgear : ModItem
    {
        ...
        public override void UpdateArmorSet(Player player)
        {
            ...
            var redGemText = $"The red gem grants {RogueStealthBoost} maximum stealth, increased rogue stats, and makes stealth only consumable by rogue weapons\n";
            var yellowGemText = $"The yellow gem provides increased melee stats and makes melee attacks release shards on hit with a cooldown. This cooldown is shorter for true melee attacks\n";
            var greenGemText = $"The green gem provides increased ranged stats and causes flechettes to fly swiftly towards targets when they are damaged by a ranged projectile\n";
            var blueGemText = $"The blue gem grants {SummonMinionCountBoost} extra maximum minions, increased minion damage, and reduces the penalty for summoner items while holding a non-summoner weapon\n";
            var purpleGemText = $"The violet gem grants {MagicManaBoost} extra maximum mana, increased magic stats, and makes mana rapidly regenerate when holding a non-magic weapon\n";
            var pinkGemText = $"The pink base gem grants {BaseGemDefenseBoost} extra defense, extra damage reduction, increased movement speed, jump speed, and +{BaseGemLifeRegenBoost} life regen\n";
