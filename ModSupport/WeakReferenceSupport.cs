    ...
    internal class WeakReferenceSupport
    {
        ...
        private static void BossChecklistSupport()
        {
            ...
            if (bossChecklist != null)
            {
                ...
                bossChecklist.Call("AddBossWithInfo", "Desert Scourge", 1.5f, (Func<bool>)(() => CalamityWorld.downedDesertScourge), "Use a [i:" + ModContent.ItemType<DriedSeafood>() + "] in the Desert Biome"); //1
                bossChecklist.Call("AddBossWithInfo", "Crabulon", 2.5f, (Func<bool>)(() => CalamityWorld.downedCrabulon), "Use a [i:" + ModContent.ItemType<DecapoditaSprout>() + "] in the Mushroom Biome"); //1.5
                ...
                bossChecklist.Call("AddBossWithInfo", "Slime God", 5.5f, (Func<bool>)(() => CalamityWorld.downedSlimeGod), "Use an [i:" + ModContent.ItemType<OverloadedSludge>() + "]"); //4
                bossChecklist.Call("AddBossWithInfo", "Cryogen", 6.5f, (Func<bool>)(() => CalamityWorld.downedCryogen), "Use a [i:" + ModContent.ItemType<CryoKey>() + "] in the Snow Biome"); //5
                bossChecklist.Call("AddBossWithInfo", "Brimstone Elemental", 7.5f, (Func<bool>)(() => CalamityWorld.downedBrimstoneElemental), "Use a [i:" + ModContent.ItemType<CharredIdol>() + "] in the Hell Crag"); //6
                ...
                bossChecklist.Call("AddBossWithInfo", "Ceaseless Void", 15.1f, (Func<bool>)(() => CalamityWorld.downedSentinel1), "Use a [i:" + ModContent.ItemType<RuneofCos>() + "] in the Dungeon"); //12
                bossChecklist.Call("AddBossWithInfo", "Storm Weaver", 15.2f, (Func<bool>)(() => CalamityWorld.downedSentinel2), "Use a [i:" + ModContent.ItemType<RuneofCos>() + "] in Space"); //13
                bossChecklist.Call("AddBossWithInfo", "Signus", 15.3f, (Func<bool>)(() => CalamityWorld.downedSentinel3), "Use a [i:" + ModContent.ItemType<RuneofCos>() + "] in the Underworld"); //14
                bossChecklist.Call("AddBossWithInfo", "Polterghast", 15.5f, (Func<bool>)(() => CalamityWorld.downedPolterghast), "Use a [i:" + ModContent.ItemType<NecroplasmicBeacon>() + "] in the Dungeon or kill 30 phantom spirits"); //11
                bossChecklist.Call("AddBossWithInfo", "Devourer of Gods", 16f, (Func<bool>)(() => CalamityWorld.downedDoG), "Use a [i:" + ModContent.ItemType<CosmicWorm>() + "]"); //15
                bossChecklist.Call("AddBossWithInfo", "Yharon", 17f, (Func<bool>)(() => CalamityWorld.downedYharon), "Use a [i:" + ModContent.ItemType<ChickenEgg>() + "] in the Jungle Biome"); //17
                bossChecklist.Call("AddBossWithInfo", "Supreme Calamitas", 18f, (Func<bool>)(() => CalamityWorld.downedSCal), "Use an [i:" + ModContent.ItemType<EyeofExtinction>() + "]"); //18
            }
        }
