...
namespace CalamityMod
{
    ...
    internal class WeakReferenceSupport
    {
        private static readonly Dictionary<string, float> BossDifficulty = new Dictionary<string, float>
        {
            ...
            { "Dragonfolly", 17.6f },
            { "Providence", 18.01f }, // Thorium's Ragnarok is 15f
            { "CeaselessVoid", 18.5f },
            { "StormWeaver", 18.51f },
            { "Signus", 18.52f },
            { "Polterghast", 19f },
