...
{
    public class StratusTable : ModTile
    {
        public override void SetStaticDefaults() => this.SetUpTable(ModContent.ItemType<Items.Placeables.FurnitureStratus.StratusTable>(), true);
