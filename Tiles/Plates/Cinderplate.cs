...
namespace CalamityMod.Tiles.Plates
{
    public class Cinderplate : ModTile
    {
        ...
        public override void SetDefaults()
        {
            if (!Main.dedServ)
            {
                PulseTexture = ModContent.GetTexture("CalamityMod/Tiles/Plates/CinderplatePulse");
                PulseColors = new Color[PulseTexture.Width];
                PulseTexture.GetData(PulseColors);
                GlowTexture = ModContent.GetTexture("CalamityMod/Tiles/Plates/CinderplateGlow");
            }
