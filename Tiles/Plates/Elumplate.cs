...
namespace CalamityMod.Tiles.Plates
{
    public class Elumplate : ModTile
    {
        public override void SetDefaults()
        {
            ...
            mineResist = 1f;
            minPick = 65;
            drop = ModContent.ItemType<Items.Placeables.Plates.Elumplate>();
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.GetTexture("CalamityMod/Tiles/Plates/ElumplateGlow");
            Vector2 zero = Main.drawToScreen ? Vector2.Zero : new Vector2(Main.offScreenRange);
            Vector2 drawOffset = new Vector2(i * 16 - Main.screenPosition.X, j * 16 - Main.screenPosition.Y) + zero;

            // Glowmask 'pulse' effect
            Texture2D pulseMap = ModContent.GetTexture("CalamityMod/Tiles/Plates/ElumplatePulse");
