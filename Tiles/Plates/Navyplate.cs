...
namespace CalamityMod.Tiles.Plates
{
    public class Navyplate : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.GetTexture("CalamityMod/Tiles/Plates/NavyplateGlow");
            Vector2 zero = Main.drawToScreen ? Vector2.Zero : new Vector2(Main.offScreenRange);
            Vector2 drawOffset = new Vector2(i * 16 - Main.screenPosition.X, j * 16 - Main.screenPosition.Y) + zero;

            // Glowmask 'pulse' effect
            Texture2D pulseMap = ModContent.GetTexture("CalamityMod/Tiles/Plates/NavyplatePulse");
