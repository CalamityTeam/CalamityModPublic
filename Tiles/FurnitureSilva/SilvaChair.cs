...
namespace CalamityMod.Tiles.FurnitureSilva
{
    ...
    {
        public override void SetStaticDefaults() => this.SetUpChair(ModContent.ItemType<Items.Placeables.FurnitureSilva.SilvaChair>(), true);
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureSilva.SilvaChair>());
