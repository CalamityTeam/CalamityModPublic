...
namespace CalamityMod.Tiles.FurnitureExo
{
    public class ExoChandelierTile : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 48, ModContent.ItemType<ExoChandelier>());
        }
        ...
        {
            CalamityUtils.DrawFlameEffect(ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureExo/ExoChandelierTileFlame"), i, j);
        }
    }
}
