...
namespace CalamityMod.Tiles.FurnitureExo
{
    public class ExoBathtubTile : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<ExoBathtub>());
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureExo/ExoBathtubGlow");
