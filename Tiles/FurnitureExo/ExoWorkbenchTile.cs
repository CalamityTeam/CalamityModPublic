...
namespace CalamityMod.Tiles.FurnitureExo
{
    public class ExoWorkbenchTile : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<ExoWorkbench>());
        }
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureExo/ExoWorkbenchGlow");
