...
namespace CalamityMod.Tiles.FurnitureExo
{
    public class ExoLanternTile : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<ExoLantern>());
        }
        ...
        {
            CalamityUtils.DrawFlameEffect(ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureExo/ExoLanternTileFlame").Value, i, j);
        }
    }
}
