...
namespace CalamityMod.Tiles.FurnitureCosmilite
{
    public class CosmiliteDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            OpenDoorID/* tModPorter Note: Removed. Use TileID.Sets.OpenDoorID instead */ = ModContent.TileType<CosmiliteDoorOpen>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeables.FurnitureCosmilite.CosmiliteDoor>());
        }
