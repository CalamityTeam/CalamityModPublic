...
{
    public class CosmiliteLamp : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureCosmilite.CosmiliteLamp>());
        }
