...
namespace CalamityMod.Tiles.FurnitureAshen
{
    public class AshenSofa : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureAshen.AshenSofa>());
        }
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.BenchMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurnitureAshen.AshenSofa>());
