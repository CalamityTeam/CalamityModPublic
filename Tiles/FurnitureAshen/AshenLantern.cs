...
namespace CalamityMod.Tiles.FurnitureAshen
{
    public class AshenLantern : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureAshen.AshenLantern>());
        }
        ...
        {
            CalamityUtils.DrawFlameEffect(ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureAshen/AshenLanternFlame"), i, j);
        }
