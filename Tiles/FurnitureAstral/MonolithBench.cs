...
namespace CalamityMod.Tiles.FurnitureAstral
{
    class MonolithBench : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.GetTexture("CalamityMod/Tiles/FurnitureAstral/MonolithBenchGlow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithBench>());
        }
    }
}
