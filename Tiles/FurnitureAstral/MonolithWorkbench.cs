...
namespace CalamityMod.Tiles.FurnitureAstral
{
    public class MonolithWorkBench : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureAstral/MonolithWorkBenchGlow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 16, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithWorkBench>());
        }
    }
}
