...
namespace CalamityMod.Tiles.FurnitureAstral
{
    public class MonolithChair : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureAstral/MonolithChairGlow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithChair>());
        }
    }
}
