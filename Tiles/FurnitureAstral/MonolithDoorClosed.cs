...
namespace CalamityMod.Tiles.FurnitureAstral
{
    public class MonolithDoorClosed : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureAstral/MonolithDoorClosedGlow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithDoor>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.showItemIcon2 = ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithDoor>();
        }
    }
}
