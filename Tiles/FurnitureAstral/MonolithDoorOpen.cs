...
namespace CalamityMod.Tiles.FurnitureAstral
{
    public class MonolithDoorOpen : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.GetTexture("CalamityMod/Tiles/FurnitureAstral/MonolithDoorOpenGlow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 32, 48, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithDoor>());
        }
