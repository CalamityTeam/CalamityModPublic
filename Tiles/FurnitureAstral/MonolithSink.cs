...
namespace CalamityMod.Tiles.FurnitureAstral
{
    public class MonolithSink : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/FurnitureAstral/MonolithSinkGlow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.FurnitureAstral.MonolithSink>());
        }
    }
}
