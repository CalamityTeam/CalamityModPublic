...
namespace CalamityMod.Tiles.Pylons
{
    ...
    public class SulphurPylonTile : ModPylon
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(Color.YellowGreen, pylonName);
        }
        ...
        public override int? IsPylonForSale(int npcType, Player player, bool isNPCHappyEnough)
        {
            ...
            return player.Calamity().ZoneSulphur ? ModContent.ItemType<SulphurPylon>() : null;
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<SulphurPylon>();
        }

        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ModContent.GetInstance<TECalamityPylon>().Kill(i, j);
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 2, 3, ModContent.ItemType<SulphurPylon>());
        }
        ...
        public override bool ValidTeleportCheck_BiomeRequirements(TeleportPylonInfo pylonInfo, SceneMetrics sceneData)
        {
            ...
            return BiomeTileCounterSystem.SulphurTiles >= 100;
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            if (!player.dead && player.active)
                // Grants underwater breathing & sulphuric poison immunity
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(mouseOver, pylonInfo, "Mods.CalamityMod.ItemName.SulphurPylon", ref mouseOverText);
        }
    }
}
