...
{
    public class HostileWaterTurret : ModTile
    {
        ...
        public override string Texture => "CalamityMod/Tiles/PlayerTurrets/PlayerWaterTurret";
        public override void SetStaticDefaults()
        {
            ...
            ModTileEntity te = ModContent.GetInstance<TEHostileWaterTurret>();
        ...
        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            ...
            TEHostileWaterTurret te = CalamityUtils.FindTileEntity<TEHostileWaterTurret>(i, j, Width, Height, SheetSquare);
            te?.Kill(left, top);
        }
