...
{
    public class HostilePlagueTurret : ModTile
    {
        ...
        public override string Texture => "CalamityMod/Tiles/PlayerTurrets/PlayerPlagueTurret";
        public override void SetStaticDefaults()
        {
            ...
            ModTileEntity te = ModContent.GetInstance<TEHostilePlagueTurret>();
