...
namespace CalamityMod.Tiles.DraedonStructures
{
    public class AgedLaboratoryDoorOpen : ModTile
    {
        ...
        public override void HitWire(int i, int j) => ILChanges.DoorSwap(ModContent.TileType<AgedLaboratoryDoorClosed>(), ModContent.TileType<AgedLaboratoryDoorOpen>(), i, j, true);

        public override void KillMultiTile(int i, int j, int frameX, int frameY)
        {
            Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<AgedLaboratoryDoorItem>());
        }
