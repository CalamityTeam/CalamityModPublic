...
namespace CalamityMod.Tiles.FurnitureAcidwood
{
    public class AcidwoodDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            OpenDoorID/* tModPorter Note: Removed. Use TileID.Sets.OpenDoorID instead */ = ModContent.TileType<AcidwoodDoorOpen>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<AcidwoodDoor>());
        }
