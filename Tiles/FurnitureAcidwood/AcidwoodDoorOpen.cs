...
namespace CalamityMod.Tiles.FurnitureAcidwood
{
    public class AcidwoodDoorOpen : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            CloseDoorID/* tModPorter Note: Removed. Use TileID.Sets.CloseDoorID instead */ = ModContent.TileType<AcidwoodDoorClosed>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<AcidwoodDoor>());
        }
