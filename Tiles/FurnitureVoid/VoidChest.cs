...
namespace CalamityMod.Tiles.FurnitureVoid
{
    public class VoidChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            ContainerName/* tModPorter Note: Removed. Override DefaultContainerName instead */.SetDefault("Void Chest");
            ItemDrop = ModContent.ItemType<Items.Placeables.FurnitureVoid.VoidChest>();
        }
