...
namespace CalamityMod.Tiles.FurnitureOtherworldly
{
    ...
    public class OtherworldlyDresser : ModTile
    {
        ...
        {
            CalamityUtils.DresserMouseFar<Items.Placeables.FurnitureOtherworldly.OtherworldlyDresser>();
        }

        public override void MouseOver(int i, int j)
        {
            CalamityUtils.DresserMouseOver<Items.Placeables.FurnitureOtherworldly.OtherworldlyDresser>();
        }
