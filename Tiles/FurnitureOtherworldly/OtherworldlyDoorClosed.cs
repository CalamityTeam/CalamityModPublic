...
namespace CalamityMod.Tiles.FurnitureOtherworldly
{
    ...
    public class OtherworldlyDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            OpenDoorID/* tModPorter Note: Removed. Use TileID.Sets.OpenDoorID instead */ = ModContent.TileType<OtherworldlyDoorOpen>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeables.FurnitureOtherworldly.OtherworldlyDoor>());
        }
