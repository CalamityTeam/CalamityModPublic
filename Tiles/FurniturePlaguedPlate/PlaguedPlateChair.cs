...
namespace CalamityMod.Tiles.FurniturePlaguedPlate
{
    ...
    {
        public override void SetStaticDefaults() => this.SetUpChair(ModContent.ItemType<Items.Placeables.FurniturePlagued.PlaguedPlateChair>(), true);
        ...
        public override void MouseOver(int i, int j) => CalamityUtils.ChairMouseOver(i, j, ModContent.ItemType<Items.Placeables.FurniturePlagued.PlaguedPlateChair>());
