...
namespace CalamityMod.Tiles.FurniturePlaguedPlate
{
    public class PlaguedPlateBed : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 64, 32, ModContent.ItemType<CalamityMod.Items.Placeables.FurniturePlagued.PlaguedPlateBed>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<CalamityMod.Items.Placeables.FurniturePlagued.PlaguedPlateBed>();
        }
    }
}
