...
namespace CalamityMod.Tiles.FurniturePlaguedPlate
{
    public class PlaguedPlateDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            OpenDoorID/* tModPorter Note: Removed. Use TileID.Sets.OpenDoorID instead */ = ModContent.TileType<PlaguedPlateDoorOpen>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeables.FurniturePlagued.PlaguedPlateDoor>());
        }
