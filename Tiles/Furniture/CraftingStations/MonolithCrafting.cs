...
namespace CalamityMod.Tiles.Furniture.CraftingStations
{
    public class MonolithCrafting : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.Request<Texture2D>("CalamityMod/Tiles/Furniture/CraftingStations/MonolithCraftingGlow").Value;
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeables.Furniture.CraftingStations.MonolithCrafting>());
        }
    }
}
