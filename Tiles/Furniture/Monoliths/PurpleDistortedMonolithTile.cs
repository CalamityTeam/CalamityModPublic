...
{
    public class PurpleDistortedMonolithTile : ModTile
    {
        ...
        {
            if (Main.tile[i, j].TileFrameY < 92)
            {
                return;
            }
            ...
            if (player.active)
            {
                Main.LocalPlayer.Calamity().monolithDevourerPShader = 30;
            }
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<PurpleDistortedMonolith>();
        }
