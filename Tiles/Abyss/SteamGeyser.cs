...
namespace CalamityMod.Tiles.Abyss
{
    public class SteamGeyser : ModTile
    {
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            if (!Main.gamePaused && t.TileFrameX % 36 == 0 && t.TileFrameY % 36 == 0 && Collision.CanHitLine(spawnPosition, 1, 1, spawnPosition - Vector2.UnitY * 100f, 1, 1) && Main.rand.NextBool(5))
            {
