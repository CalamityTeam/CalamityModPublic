...
namespace CalamityMod.Tiles.FurnitureEutrophic
{
    public class EutrophicDresser : ModTile
    {
        ...
        {
            CalamityUtils.DresserMouseFar<Items.Placeables.FurnitureEutrophic.EutrophicDresser>();
        }

        public override void MouseOver(int i, int j)
        {
            CalamityUtils.DresserMouseOver<Items.Placeables.FurnitureEutrophic.EutrophicDresser>();
        }
