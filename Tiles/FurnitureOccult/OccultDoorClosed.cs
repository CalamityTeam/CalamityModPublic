...
namespace CalamityMod.Tiles.FurnitureOccult
{
    public class OccultDoorClosed : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            OpenDoorID = ModContent.TileType<OccultDoorOpen>();
        }
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.Placeables.FurnitureOccult.OccultDoor>());
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<Items.Placeables.FurnitureOccult.OccultDoor>();
        }
    }
}
