...
namespace CalamityMod.Tiles
{
    public class OccultChest : ModTile
    {
        public override void SetDefaults()
        {
            ...
            chestDrop = ModContent.ItemType<OccultChest>();
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.showItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Occult Chest";
                if (player.showItemIconText == "Occult Chest")
                {
                    player.showItemIcon2 = ModContent.ItemType<OccultChest>();
