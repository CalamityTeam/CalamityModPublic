...
namespace CalamityMod.Tiles
{
    public class ProfanedChest : ModTile
    {
        public override void SetDefaults()
        {
            ...
            chestDrop = ModContent.ItemType<ProfanedChest>();
        }
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.showItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Profaned Chest";
                if (player.showItemIconText == "Profaned Chest")
                {
                    player.showItemIcon2 = ModContent.ItemType<ProfanedChest>();
