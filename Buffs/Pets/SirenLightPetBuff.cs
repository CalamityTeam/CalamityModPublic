...
namespace CalamityMod.Buffs.Pets
{
    public class SirenLightPetBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            {
                Projectile.NewProjectile(player.GetProjectileSource_Buff(buffIndex), player.Center, Vector2.Zero, ModContent.ProjectileType<SirenYoung>(), 0, 0f, player.whoAmI, 0f, 0f);
            }
        }
    }
}
