	...
	public static partial class NPCStats
	{
		...
		internal static void LoadEnemyStats()
		{
			...
			EnemyStats.ProjectileDamageValues = new SortedDictionary<Tuple<int, int>, int[]>
			{
				...
				{ new Tuple<int, int>(ModContent.NPCType<AureusSpawn>(), ModContent.ProjectileType<AstralFlame>()), new int[] { 74, 128, 148, 160, 222 } },
				...
				{ new Tuple<int, int>(ModContent.NPCType<SupremeCalamitas>(), ModContent.ProjectileType<BrimstoneGigaBlast>()), new int[] { 360, 540, 568, 584, 858 } },
				{ new Tuple<int, int>(ModContent.NPCType<SupremeCalamitas>(), ModContent.ProjectileType<BrimstoneFireblast>()), new int[] { 400, 608, 640, 658, 960 } },
				...
				{ new Tuple<int, int>(ModContent.NPCType<Artemis>(), ModContent.ProjectileType<ArtemisLaserBeamStart>()), new int[] { 360, 540, 568, 584, 858 } },
