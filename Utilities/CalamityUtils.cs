...
namespace CalamityMod
{
    public static class CalamityUtils
    {
        ...
        public static float AverageDamage(this Player player) => player.allDamage - 1f + ((player.meleeDamage + player.magicDamage + player.rangedDamage + player.Calamity().throwingDamage + player.minionDamage) / 5);
