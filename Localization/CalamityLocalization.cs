    ...
    public class CalamityLocalization
    {
        ...
        public static void Load()
        {
            _localizations = new[]
            {
                ...
                new [] { "DraedonExoPhase2Text1", "Designs improved with time and knowledge is the essence of my work." },
                new [] { "DraedonExoPhase2Text2", "Through no other method can I approach perfection." },
                new [] { "DraedonExoPhase3Text1", "Your performance falls neatly within the margins of error. Very good!" },
                new [] { "DraedonExoPhase3Text2", "That is quite satisfactory. We will proceed to the next phase of testing." },
                new [] { "DraedonExoPhase4Text1", "Ever since I was alerted to your presence, I have processed your battles in order to make my machines stronger." },
                new [] { "DraedonExoPhase4Text2", "Even now, I monitor your actions— nothing is outside the bounds of my calculations." },
                new [] { "DraedonExoPhase5Text1", "Curious. Very curious." },
                new [] { "DraedonExoPhase5Text2", "Your behavior remains consistent yet you progress steadily against more difficult challenges." },
                new [] { "DraedonExoPhase6Text1", "It seems nothing is impossible." },
                new [] { "DraedonExoPhase6Text2", "I had not accounted for you to progress this far."},
                new [] { "DraedonExoPhase6Text3", "I shall no longer let my calculations impede my observation of this battle." },
                new [] { "DraedonExoPhase6Text4", "You will know the full fury of my final machine." },
