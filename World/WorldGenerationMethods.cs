    ...
    public class WorldGenerationMethods : ModWorld
    {
		...
		public static void SpecialChest(int itemChoice)
		{
			...
			switch (itemChoice) //0 to 9
			{
				...
				case 1: item = (WorldGen.crimson ? mod.ItemType("CrimsonEffigy") : mod.ItemType("CorruptionEffigy")); chestType = (WorldGen.crimson ? 43 : 3); break;
				case 2: item = mod.ItemType("OnyxExcavatorKey"); chestType = 44; break;
				case 3: item = mod.ItemType("TundraLeash"); chestType = 47; break;
				case 4: item = mod.ItemType("LuxorsGift"); chestType = 30; break;
				case 5: item = mod.ItemType("FungalSymbiote"); chestType = 32; break;
				case 6: item = mod.ItemType("UnstablePrism"); chestType = 50; break;
				case 7: item = mod.ItemType("GladiatorsLocket"); chestType = 51; break;
