...
namespace CalamityMod.World.Planets
{
    public class MainPlanet : Planetoid
    {
        ...
        public void PlacePlanet(Point origin, int radius)
        {
            ...
            SchematicPlacementHelpers.PlaceStructure("Planetoid Laboratory", new Point(origin.X - 33, origin.Y - 17), SchematicPlacementHelpers.PlacementAnchorType.TopLeft, ref hasPlacedLogAndSchematic, new Action<Chest, int, bool>((chest, type, hasPlaced) => DraedonStructures.FillPlanetoidLaboratoryChest(chest, type, hasPlaced)));
