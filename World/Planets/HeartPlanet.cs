...
namespace CalamityMod.World.Planets
{
    public class HeartPlanet : Planetoid
    {
        ...
        public void PlacePlanet(Point origin, int radius)
        {
            ...
            ushort tile = WorldGen.getGoodWorldGen ? TileID.HellstoneBrick : gold ? TileID.GoldBrick : TileID.PlatinumBrick;
            ushort wall = WorldGen.getGoodWorldGen ? WallID.HellstoneBrick : gold ? WallID.GoldBrick : WallID.PlatinumBrick;
