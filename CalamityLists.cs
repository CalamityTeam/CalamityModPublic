...
namespace CalamityMod
{
    public class CalamityLists
    {
        ...
        public static void LoadLists()
        {
            ...
            natureWeaponList = new List<int>() // Includes drops and crafts from the Scourges, Giant Clam, Fishrons, Crabulon, Queen Bee, Abyss minibosses, GSS, and Acid Rain.
            {
                ItemID.BladeofGrass,
                ...
                ItemType<ClamCrusher>(),
                ItemType<ClamorRifle>(),
                ItemType<ShellfishStaff>(), // Just here for consistency, it cannnot recieve any Nature Weapon bonuses.
