        ...
        public override void AI()
        {
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				if (flag11)
				{
					...
					num404 *= num406;
					num405 *= num406;
					int beam = Projectile.NewProjectile(projectile.Center.X - 4f, projectile.Center.Y, num404, num405, 260, (int)(6f * player.minionDamage), projectile.knockBack, projectile.owner, 0f, 0f);
