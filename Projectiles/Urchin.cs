        	...
        	if (projectile.owner == Main.myPlayer)
			{
				...
				if (flag18)
				{
					...
					for (int num252 = 0; num252 < num251; num252++)
					{
						...
						int spore = Projectile.NewProjectile(projectile.Center.X - 4f, projectile.Center.Y, value15.X, value15.Y, mod.ProjectileType("UrchinSpike"), (int)((double)7 * player.minionDamage), 1f, projectile.owner, 0f, 0f);
