...
namespace CalamityMod.Projectiles
{
    public class HiveMissile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
			...
			{
        		Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, mod.ProjectileType("HiveExplosion"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
				int num516 = 3;
