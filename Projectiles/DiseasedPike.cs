    ...
    public class DiseasedPike : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
    	{
        	...
        	if (projectile.owner == Main.myPlayer)
        	{
	        	for (int i = 0; i <= 3; i++)
	        	{
	        		Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("PlagueSeeker"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
	        	}
        	}
		}
    }
