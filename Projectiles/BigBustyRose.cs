...
namespace CalamityMod.Projectiles
{
    public class BigBustyRose : ModProjectile
    {
        ...
        {
        	bool flag64 = projectile.type == mod.ProjectileType("BigBustyRose");
			...
			if (projectile.ai[0] == 0f)
			{
				...
				int num658 = mod.ProjectileType("BrimstoneHellfireballFriendly");
				if (flag25 && projectile.ai[1] == 0f)
				{
					...
					if (Main.myPlayer == projectile.owner && Collision.CanHitLine(projectile.position, projectile.width, projectile.height, vector46, 0, 0))
					{
						...
						int num659 = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value19.X, value19.Y, num658, projectile.damage, 0f, Main.myPlayer, 1f, 0f);
