...
namespace CalamityMod.Projectiles.Melee
{
    public class MourningstarFlail : BaseWhipProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center.X, target.Center.Y, 0f, 0f, ProjectileID.SolarWhipSwordExplosion, Projectile.damage, knockback, Projectile.owner, 0f, 0.85f + Main.rand.NextFloat() * 1.15f);
