...
{
    public class GalaxySmasherHammerMelee : ModProjectile
    {
        private static float RotationIncrement = 0.22f;
        private static int Lifetime = 240;
        private static float ReboundTime = 24f;
        ...
        public override void AI()
        {
            ...
            {
                int dustType = (Main.rand.Next(6) == 0) ? 112 : 173;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            target.AddBuff(mod.BuffType("GodSlayerInferno"), 480);
