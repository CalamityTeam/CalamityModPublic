...
namespace CalamityMod.Projectiles
{
    public class ExcelsusBlue : ModProjectile
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            spriteBatch.Draw(mod.GetTexture("Projectiles/Melee/ExcelsusBlueGlow"), projectile.Center - Main.screenPosition, null, color, projectile.rotation, origin, projectile.scale, SpriteEffects.None, 0f);
        }
