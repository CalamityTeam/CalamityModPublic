...
namespace CalamityMod.Projectiles.Melee
{
    public class Excelsus : ModProjectile
    {
		...
		public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			spriteBatch.Draw(mod.GetTexture("Projectiles/Melee/ExcelsusGlow"), projectile.Center - Main.screenPosition, null, color, projectile.rotation, origin, projectile.scale, SpriteEffects.None, 0f);
		}
