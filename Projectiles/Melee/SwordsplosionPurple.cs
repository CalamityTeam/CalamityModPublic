...
namespace CalamityMod.Projectiles.Melee
{
    public class SwordsplosionPurple : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                int purpleBoi = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 66, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 150, new Color(Main.DiscoR, 100, 255), 1.2f);
        ...
        public override void OnKill(int timeLeft)
        {
            for (int k = 0; k < 7; k++)
            {
                int purpleBoi = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 66, 0f, 0f, 150, new Color(Main.DiscoR, 100, 255), 1.2f);
                Main.dust[purpleBoi].noGravity = true;
            }
        }
    }
