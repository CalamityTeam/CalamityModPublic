    ...
    public class LaserFountain : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] >= 12f)
            {
                ...
                {
                    int projectile1 = Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, SpeedX, SpeedY, ModContent.ProjectileType<NebulaShot>(), (int)(350f * Main.player[Projectile.owner].MeleeDamage()), Projectile.knockBack, Projectile.owner, 0f, 0f);
