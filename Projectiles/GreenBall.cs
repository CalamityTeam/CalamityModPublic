    ...
    public class GreenBall : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			if (projTime == 0)
			{
				...
				{
					Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X * 0.35f, projectile.velocity.Y * 0.35f, mod.ProjectileType("GreenDust"), (int)((double)projectile.damage * 0.75f), projectile.knockBack, projectile.owner, 0f, 0f);
				}
				projTime = 15;
			}
        }
