...
namespace CalamityMod.Projectiles.Summon
{
    public class SandMark : ModProjectile, ILocalizedModType
    {
        ...
        {            
            ...
            Main.EntitySpriteDraw(texture2D27, drawPos, new Microsoft.Xna.Framework.Rectangle?(rectangle), sandyColor, 0f, origin7, new Vector2(1f, 5f) * Projectile.scale * 2f, SpriteEffects.None, 0);
            Main.EntitySpriteDraw(texture2D27, drawPos, new Microsoft.Xna.Framework.Rectangle?(rectangle), alphaColor, Projectile.rotation, origin7, Projectile.scale, SpriteEffects.None, 0);
            Main.EntitySpriteDraw(texture2D27, drawPos, new Microsoft.Xna.Framework.Rectangle?(rectangle), alphaColor, 0f, origin7, new Vector2(1f, 8f) * Projectile.scale, SpriteEffects.None, 0);
            return false;
        }
    }
}
