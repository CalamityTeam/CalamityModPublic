        ...
        internal void AttackTarget(NPC target)
        {
            ...
            if (Time % 90f > 45f)
            {
                ...
                if (Time % 16f == 15f)
                {
                    ...
                    {
                        int dart = Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), eyePosition, shootVelocity, ModContent.ProjectileType<BrimstoneDartSummon>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
