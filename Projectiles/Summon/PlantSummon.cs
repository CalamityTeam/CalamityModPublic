        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[0] == 0f)
            {
                ...
                for (int num227 = 0; num227 < num226; num227++)
                {
                    ...
                    int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 44, vector7.X * 1.75f, vector7.Y * 1.75f, 100, default, 1.1f);
				...
				if (projectile.ai[0] == 0f)
				{
					if (projectile.ai[1] == 0f && flag25 && num633 < 500f)
					{
						...
						if (Main.myPlayer == projectile.owner)
						{
							...
							{
								Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value20.X, value20.Y, ModContent.ProjectileType<PlantThornBall>(), (int)(projectile.damage * 1.2f), 0f, Main.myPlayer, 0f, 0f);
							}
				...
				if (projectile.ai[0] == 0f)
				{
					...
					if (flag25 && projectile.ai[1] == 0f)
					{
						...
						if (Main.myPlayer == projectile.owner)
						{
							...
							Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value19.X, value19.Y, num658, projDmg, 0f, Main.myPlayer, 0f, 0f);
							projectile.netUpdate = true;
						}
					}
				}
