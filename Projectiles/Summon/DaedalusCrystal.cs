        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                if (flag18)
                {
                    ...
                    num404 *= num406;
                    num405 *= num406;
                    int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X - 4f, Projectile.Center.Y, num404, num405, projectileType, Projectile.damage, 5f, Projectile.owner, 0f, 0f);
