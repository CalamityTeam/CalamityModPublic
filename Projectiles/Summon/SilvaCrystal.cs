                ...
                if (Projectile.ai[0] >= 5f)
                {
                    ...
                    if (Projectile.owner == Main.myPlayer)
                    {
                        ...
                        for (int num1083 = 0; num1083 < 3; num1083 = num31 + 1)
                        {
                            ...
                            Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector156, Vector2.Zero, ModContent.ProjectileType<SilvaCrystalExplosion>(), Projectile.damage, Projectile.knockBack, Projectile.owner, x4, (float)Projectile.whoAmI);
                            num31 = num1083;
                        }
                        return;
                    }
