...
namespace CalamityMod.Projectiles.Summon
{
    public class CalamariMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                SoundEngine.PlaySound(CommonNPCSounds.GetZombieSound(35), Projectile.position);
            }
            if (Projectile.ai[0] == 2f)
            {
                ...
                {
                    SoundEngine.PlaySound(CommonNPCSounds.GetZombieSound(34), Projectile.position);
