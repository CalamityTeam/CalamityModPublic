    ...
    public class AscendantAura : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            if (Projectile.timeLeft == 300)
            {
                ...
                for (int d = 0; d < dustAmount; d++)
                {
                    ...
                    Dust spawnDust = Dust.NewDustPerfect(Owner.Center, (int)CalamityDusts.ProfanedFire, velocity);
                    spawnDust.noGravity = true;
                    spawnDust.scale = velocity.Length() * 0.01f;
                    spawnDust.velocity *= 0.2f;
                }
            }
            ...
            Color color = Main.rand.NextBool(3) ? Color.Gold : Color.PaleGoldenrod;
            ...
            // Emit some light
            Vector3 Light = new Vector3(0.245f, 0.223f, 0.097f);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < numberOfDusts; i++)
            {
                ...
                Vector2 offset = new Vector2(6f, 0).RotatedBy(rot);
                Vector2 velOffset = new Vector2(3f, 0).RotatedBy(rot);
