        ...
        public override void Kill(int timeLeft)
        {
            if (projectile.owner == Main.myPlayer)
            {
                ...
                for (int num252 = 0; num252 < num251; num252++)
                {
                    ...
                    Projectile.NewProjectile(projectile.oldPosition.X + (float)(projectile.width / 2), projectile.oldPosition.Y + (float)(projectile.height / 2), value15.X, value15.Y, ModContent.ProjectileType<GodSlayerShrapnel>(), (int)((double)projectile.damage * 0.3), 0f, projectile.owner, 0f, 0f);
                }
            }
        }
    }
