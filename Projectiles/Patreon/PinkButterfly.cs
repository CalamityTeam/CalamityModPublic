        ...
        public override void AI()
        {
        	if (projectile.localAI[0] == 0f)
        	{
				...
				for (int num227 = 0; num227 < num226; num227++)
				{
					...
					int num228 = Dust.NewDust(vector6 + vector7, 0, 0, 73, vector7.X, vector7.Y, 100, default(Color), 1.1f);
			...
			{
				bool flag23 = (Main.projectile[num638].type == mod.ProjectileType("PinkButterfly"));
			...
			{
				float velocity = 8f;
				int projectileType = mod.ProjectileType("SakuraBullet");
