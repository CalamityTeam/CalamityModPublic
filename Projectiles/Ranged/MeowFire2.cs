    ...
    public class MeowFire2 : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            if (Projectile.ai[0] > 7f)
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    int num299 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 73, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100, default, 1f);
