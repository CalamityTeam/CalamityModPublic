...
namespace CalamityMod.Projectiles.Ranged
{
    public class GreenExoArrow : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<ExoMark>(), (int)(projectile.damage * 0.6f), projectile.knockBack, projectile.owner, 0f, 0f);
            }
        }
    }
}
