    ...
    public class CondemnationArrowHoming : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (potentialTarget != null)
                projectile.velocity = (projectile.velocity * 29f + projectile.DirectionTo(potentialTarget.Center) * 21f) / 30f;
        ...
        {
            CalamityGlobalProjectile.DrawCenteredAndAfterimage(projectile, lightColor, 1);
            return false;
        }
