...
namespace CalamityMod.Projectiles.Ranged
{
    public class CondemnationHoldout : ModProjectile
    {
        ...
        public void ShootProjectiles(Vector2 tipPosition)
        {
            ...
            Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), tipPosition, shootVelocity, projectileType, arrowDamage, knockback, Projectile.owner, 0f, 0f);
        }
