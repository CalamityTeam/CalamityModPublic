        ...
        public override void AI()
        {
			...
			if (projectile.ai[0] > 5f)
			{
				...
				if (Main.rand.Next(1) == 0)
				{
					...
					{
						int num299 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, num297, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 1, default(Color), 1f);
