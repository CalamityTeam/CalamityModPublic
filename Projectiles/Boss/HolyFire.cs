...
namespace CalamityMod.Projectiles.Boss
{
    public class HolyFire : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = (Main.dayTime && !CalamityWorld.malice) ? Main.projectileTexture[Projectile.type] : ModContent.Request<Texture2D>("CalamityMod/Projectiles/Boss/HolyFireNight");
