...
{
	public class ThanatosBeamStart : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Collision.LaserScan(samplingPoint, projectile.velocity, projectile.width * projectile.scale, 3600f, samples);
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Texture2D beamMiddle = ModContent.GetTexture("CalamityMod/ExtraTextures/Lasers/ThanatosBeamMiddle");
