...
namespace CalamityMod.Projectiles.Boss
{
    public class MoltenBlast : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = (Main.dayTime && !BossRushEvent.BossRushActive) ? ModContent.Request<Texture2D>(Texture).Value : ModContent.Request<Texture2D>("CalamityMod/Projectiles/Boss/MoltenBlastNight").Value;
        ...
        {
            int blobAmt = (!Main.dayTime || BossRushEvent.BossRushActive) ? 9 : 6;
