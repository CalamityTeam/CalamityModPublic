    ...
    public class BrimstoneRay : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int num809 = 0; num809 < 2; num809++)
            {
                ...
                int num812 = Dust.NewDust(vector79, 0, 0, 235, vector80.X, vector80.Y, 0, default, 1f);
            ...
            if (Main.rand.NextBool(5))
            {
                ...
                int num813 = Dust.NewDust(vector79 + value29 - Vector2.One * 4f, 8, 8, 235, 0f, 0f, 100, default, 1.5f);
