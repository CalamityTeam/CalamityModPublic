        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                for (int num234 = num231; num234 < num231 + spawnAreaY; num234++)
                {
                    ...
                    if (tile.HasTile && !TileID.Sets.Platforms[tile.TileType] && (Main.tileSolid[(int)tile.TileType] || tile.liquid != 0))
                    {
                        num231 = num234;
                        break;
                    }
                ...
                int num236 = Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), (float)(num232 * 16 + 8), (float)(num231 * 16 - 24), 0f, 0f, ModContent.ProjectileType<Infernado2>(), 0, 4f, Main.myPlayer, 11f, 24f + (revenge ? 2f : 0f));
