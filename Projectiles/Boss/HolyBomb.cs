...
namespace CalamityMod.Projectiles.Boss
{
    public class HolyBomb : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = (Main.dayTime && !CalamityWorld.malice) ? Main.projectileTexture[projectile.type] : ModContent.GetTexture("CalamityMod/Projectiles/Boss/HolyBombNight");
