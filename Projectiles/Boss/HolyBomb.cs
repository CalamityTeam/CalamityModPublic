...
namespace CalamityMod.Projectiles.Boss
{
    public class HolyBomb : ModProjectile
    {
        ...
        {
            Texture2D texture2D13 = ((Main.dayTime && !CalamityWorld.malice) || !NPC.AnyNPCs(ModContent.NPCType<Providence>())) ? Main.projectileTexture[Projectile.type] : ModContent.Request<Texture2D>("CalamityMod/Projectiles/Boss/HolyBombNight");
