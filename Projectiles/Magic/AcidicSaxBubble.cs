        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                if (counter >= 120f)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, vector15.X, vector15.Y, ModContent.ProjectileType<AcidicSaxMist>(), (int)(BelchingSaxophone.BaseDamage * Main.player[Projectile.owner].MagicDamage()), 1f, Projectile.owner, 0f, 0f);
                }
                else
                    counter += 1f;
            }
