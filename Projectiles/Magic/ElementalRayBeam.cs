    ...
    public class ElementalRayBeam : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[1] >= 22f && Projectile.owner == Main.myPlayer)
            {
                ...
                Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<ElementOrb>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
            }
