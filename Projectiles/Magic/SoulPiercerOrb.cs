        ...
        public override void AI()
        {
			...
			if (flag14)
			{
				...
				if (projectile.localAI[0] > 24f)
				{
					...
					{
						Projectile.NewProjectile(value10.X, value10.Y, num438, num439, mod.ProjectileType("SoulPiercerBolt"), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
					}
					return;
				}
			}
