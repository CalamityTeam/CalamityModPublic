        ...
        public override void AI()
        {
        	...
        	if (projectile.owner == Main.myPlayer)
			{
				...
				if (flag18)
				{
					...
					num404 *= num406;
					num405 *= num406;
					Projectile.NewProjectile(projectile.Center.X - 4f, projectile.Center.Y, num404, num405, projectileType, (int)((double)95 * player.minionDamage), 5f, projectile.owner, 0f, 0f);
					projectile.ai[0] = 50f;
					return;
				}
			}
