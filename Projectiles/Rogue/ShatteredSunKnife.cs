            ...
            if (projectile.ai[1] == 25f)
            {
                ...
                if (projectile.owner == Main.myPlayer)
                {
                    ...
                    for (int i = 0; i < numProj; i++)
                    {
                        ...
                        int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, perturbedspeed.X * 0.2f, perturbedspeed.Y * 0.2f, ModContent.ProjectileType<ShatteredSunFireball>(), (int)((double)projectile.damage * 1.5), 1f, projectile.owner, 0f, 0f);
