...
namespace CalamityMod.Projectiles.Rogue
{
    public class ShatteredSunKnife : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int numProj = (!projectile.Calamity().stealthStrike && Main.rand.Next(0, 10) == 0) ? 6 : 5;
                ...
                if (projectile.owner == Main.myPlayer)
                {
                    ...
                    for (int i = 0; i < numProj; i++)
                    {
                        ...
                        int proj = Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, perturbedspeed.X * 0.2f, perturbedspeed.Y * 0.2f, ModContent.ProjectileType<ShatteredSunScorchedBlade>(), (int)((double)projectile.damage * 0.69), 1f, projectile.owner, 0f, 0f);
