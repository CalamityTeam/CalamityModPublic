...
namespace CalamityMod.Projectiles
{
    public class OrichalcumSpikedGemstoneProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, ModContent.ItemType<Items.OrichalcumSpikedGemstone>());
            }
        }
    }
}
