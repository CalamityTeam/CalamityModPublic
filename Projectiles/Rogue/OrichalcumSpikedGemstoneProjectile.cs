...
namespace CalamityMod.Projectiles.Rogue
{
    public class OrichalcumSpikedGemstoneProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Item.NewItem(Projectile.GetItemSource_DropAsItem(), (int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<OrichalcumSpikedGemstone>());
            }
        }
    }
}
