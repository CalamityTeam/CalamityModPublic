        ...
        public override void AI()
        {
        	...
        	if (projectile.owner == Main.myPlayer)
			{
				...
				if (flag18)
				{
					...
					int damage = NPC.downedMoonlord ? 200 : 80;
					...
					num404 *= num406;
					num405 *= num406;
					Projectile.NewProjectile(projectile.Center.X - 4f, projectile.Center.Y, num404, num405, projectileType, (int)((float)damage * damageMult), projectile.knockBack, projectile.owner, 0f, 0f);
					projectile.ai[0] = 12f;
					return;
				}
			}
