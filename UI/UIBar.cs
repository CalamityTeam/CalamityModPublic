...
namespace CalamityMod.UI
{
	public class UIBar : UIState
	{
		...
		public static int GetTickedValue() //ditto
		{
			...
			tick = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayer>(calamity).stress;
			return tick;
		}
		...
		public override void Update(GameTime gameTime)
		{
			...
			tick = Main.player[Main.myPlayer].GetModPlayer<CalamityPlayer>(calamity).stress; //updates the testing tick
			if (tick >= 10000)
			{
				tick = 10000;
			}
